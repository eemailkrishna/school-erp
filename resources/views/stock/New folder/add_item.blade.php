...
<!------------------------------------------------Start Personal Detail--------------------------------------------------->
			...
			<div class="col-md-4 ">				
					<div class="form-group" >
					  ...
					  <input type="text"  name="item_product_name" placeholder="Product Name"  value="" class="form-control" required >
					</div>
			</div>
			...
			<div class="col-md-4 ">				
					<div class="form-group" >
					  ...
					  <input type="text"  name="item_brand_name" placeholder="Product Brand"  value="" class="form-control" >
					</div>
			</div>
			...
			<div class="col-md-4 ">				
					<div class="form-group" >
					  ...
					  <input type="number"  name="item_rate" placeholder="Product Rate"  value="" class="form-control" >
					</div>
			</div>
