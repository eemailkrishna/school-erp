                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=7')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('7');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=10')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('10');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=11')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('11');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=12')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('12');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=13')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('13');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=14')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('14');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=15')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('15');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=16')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('16');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=17')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('17');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=18')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('18');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=19')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('19');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=20')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('20');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=21')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('21');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=22')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('22');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=23')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('23');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=24')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('24');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=25')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('25');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=28')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('28');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=29')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('29');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=30')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('30');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=31')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('31');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=32')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('32');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=33')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=34')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('34');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=35')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=36')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=37')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=38')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=39')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=40')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=41')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=42')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=43')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=44')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=45')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=46')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('46');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=47')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('47');">Delete</button></td>
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=48')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=49')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=50')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=51')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=52')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr align='center'>
                                ...
                                <th>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/sales_item','id=53')"
                                            style="color:#fff;"><input type="button" value="Sale "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
