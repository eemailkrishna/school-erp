        ...
        <div class="col-xs-12">
            ...
            <div <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <a href="javascript:get_content('stock/add_item')"> <button style="float:right;" type="button"
                            class="btn btn-primary">+ Add New Item</button></a>
                </div>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=1')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=1')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('1');">Delete</button></td>
                                    </center>
                                </th>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=2')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=2')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('2');">Delete</button></td>
                                    </center>
                                </th>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=3')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=3')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('3');">Delete</button></td>
                                    </center>
                                </th>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=4')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=4')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('4');">Delete</button></td>
                                    </center>
                                </th>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=5')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=5')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('5');">Delete</button></td>
                                    </center>
                                </th>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=6')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=6')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('6');">Delete</button></td>
                                    </center>
                                </th>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=7')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=7')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=8')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=8')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('8');">Delete</button></td>
                                    </center>
                                </th>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=9')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=9')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                                            onclick="return valid('9');">Delete</button></td>
                                    </center>
                                </th>
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=10')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=10')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=11')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=11')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=12')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=12')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=13')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=13')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=14')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=14')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=15')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=15')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=16')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=16')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
                            ...
                            <tr align='center'>
                                ...
                                <th style="width:50" ;>
                                    <center>
                                        ...
                                        <a href="javascript:post_content('stock/buy_item','id=17')"
                                            style="color:#fff;"><input type="button" value="Buy "
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:post_content('stock/edit_item','id=17')"
                                            style="color:#fff;"><input type="button" value="Edit"
                                                class="btn btn-default"
                                                style="background-color:#00a654;color:#fff;"></a> &nbsp;
                                        <button type="button" class="btn btn-danger"
