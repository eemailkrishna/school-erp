	  ...
	  <div class="box box-success ">
          ...
          <div class="small-box" style="background-color:#804040;">
            <div class="inner"><br>
              <h3 style="font-size:22px;margin-left:10px;color:#fff;">CC Form</h3>
               ...
               <a href="javascript:get_content('certificate/character_certificate_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#804040;">
            <div class="inner"><br>
              ...
              <a href="javascript:get_content('certificate/character_certificate_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#9F2B68;">
            <div class="inner"><br>
             ...
             <a href="javascript:get_content('certificate/event_certificate_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#9F2B68;">
            <div class="inner"><br>
             ...
             <a href="javascript:get_content('certificate/event_certificate_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#E32636;">
            <div class="inner"><br>
              ...
              <a href="javascript:get_content('certificate/sport_certificate_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#E32636;">
            ...
            <a href="javascript:get_content('certificate/sport_certificate_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#3F7ED0;">
            <div class="inner"><br>
              ...
              <a href="javascript:get_content('certificate/tc_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#3F7ED0;">
            <div class="inner"><br>
              ...
              <a href="javascript:get_content('certificate/tc_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#138D75;">
            <div class="inner"><br>
              ...
              <a href="javascript:get_content('certificate/bonafied_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#138D75;">
            <div class="inner"><br>
              ...
              <a href="javascript:get_content('certificate/bonafied_certificate_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
          ...
          <div class="small-box" style="background-color:#FF7E00;">
            <div class="inner"><br>
              <h3 style="font-size:22px;margin-left:10px;color:#fff;">Tu.Fee Cert.<small style="color:#fff;"></small></h3>
                ...
                <a href="javascript:get_content('certificate/tutionfee_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
          ...
          <div class="small-box" style="background-color:#FF7E00;">
            <div class="inner"><br>
              <h3 style="font-size:22px;margin-left:10px;color:#fff;">Tu.Fee Cer.List</h3>
               ...
               <a href="javascript:get_content('certificate/tutionfee_certificate_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
          ...
          <div class="small-box" style="background-color:#6C3483;">
            <div class="inner"><br>
              <h3 style="font-size:22px;margin-left:10px;color:#fff;">Ann.Fee Cert.<small style="color:#fff;"></small></h3>
               ...
               <a href="javascript:get_content('certificate/annualfee_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#6C3483;">
            ...
            <a href="javascript:get_content('certificate/annualfee_certificate_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#85929E;">
            <div class="inner"><br>
              ...
              <a href="javascript:get_content('certificate/caste_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#85929E;">
            ...
            <a href="javascript:get_content('certificate/caste_certificate_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
	...
	<a href="javascript:get_content('certificate/other_certificate_form')">
        <div class="col-lg-3 col-xs-6" style="display:none">
          <div class="small-box" style="background-color:#85929E;">
            ...
            <a href="javascript:get_content('certificate/other_certificate_form')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
	</a>
    ...
    <a href="javascript:get_content('certificate/other_certificate_list')">
        <div class="col-lg-3 col-xs-6" style="display:none">
          <div class="small-box" style="background-color:#85929E;">
            <div class="inner"><br>
              ...
              <a href="javascript:get_content('certificate/other_certificate_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#DAF7A6;">
            ...
            <a href="javascript:get_content('certificate/birth_certificate')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
	</a>
