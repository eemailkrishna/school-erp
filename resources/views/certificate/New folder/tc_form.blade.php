...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			 ...
			 <div class="col-md-6 ">				
				...
				<div class="form-group">
						  <label>Tc Generate No.</label>
						   <input type="text"  id="tc_generate_no" name="tc_generate_no" value="2147483647" placeholder="Tc Generate No." class="form-control" >
				</div>
				</div>
				</div>
			...
			<div class="col-md-3 ">
				...
				<div class="col-md-3 ">
						<div class="form-group">
						  <label>Class</label>
						   <input type="text"  name="tc_student_class" value="" placeholder="Class"  id="student_class" class="form-control" readonly>
				...
				<div class="col-md-3 ">	
					<div class="form-group" >
					  ...
					  <input type="text"  name="tc_student_sssm_id_no" id="tc_student_sssm_id_no" placeholder="SSSM Id No."  value="" class="form-control"  readonly>
					</div>
				  </div>
				<div class="col-md-3  ">	
					<div class="form-group" >
					  <label>Student Unique Id</label>
					  <input type="text"  name="tc_student_uid_no" id="tc_student_uid_no" placeholder="Student Unique Id"  value="" class="form-control" readonly>
					</div>
				  </div>
				  <div class="col-md-3 ">	
					<div class="form-group" >
					  <label>Father's Name</label>
					  <input type="text"  name="tc_student_father_name" id="tc_student_father_name" placeholder="Father's Name"  value="" class="form-control" readonly>
					</div>
				  </div>
				<div class="col-md-3 ">	
				<div class="form-group" >
					  <label>Mother's Name</label>
					  <input type="text"  name="tc_mother_name" id="tc_mother_name" placeholder="Mother's Name"  value="" class="form-control" readonly>
					</div>
				  ...
				  <div class="col-md-3 ">	
					<div class="form-group" >
					  ...
					  <input type="text"  name="date_of_birth" id="date_of_birth" placeholder="Date Of Birth"  value="" class="form-control">
					</div>
				  </div>
				  <div class="col-md-3 ">	
					<div class="form-group" >
					  <label>Date Of Birth(word)</label>
					  <input type="text"  name="date_of_birth_in_word" id="date_of_birth_in_word" placeholder="Date Of Birth(word)"  value="" class="form-control">
					</div>
				  </div>
				  <div class="col-md-3 ">	
					<div class="form-group" >
					 <label>Student Admission No.</label>
					  <input type="text"  name="tc_admission_no" id="tc_admission_no" placeholder="Student Admission No."  value="" class="form-control" readonly>
				  ...
				  <div class="col-md-3 ">	
					<div class="form-group" >
					  ...
					  <input type="text"  name="tc_admission_date" id="tc_admission_date" placeholder="Admission Date"  value="" class="form-control" readonly>
					</div>
				  </div>
				    <div class="col-md-3 ">	
					<div class="form-group" >
					<label>Class In Which Admitted</label>
					  <input type="text"  name="class_in_which_admitted" id="class_in_which_admitted" placeholder="Class In Which Admitted"  value="" class="form-control" >
				   ...
				   <div class="col-md-3 ">	
					<div class="form-group" >
					 <label>Issue Date</label>
					  <input type="date"  name="date_of_school_leaving" id="date_of_school_leaving" placeholder="Issue Date"  value="2022-12-05" class="form-control">
					...
					<label>Reason For Leaving</label>
					  <input type="text"  name="region_for_leaving" placeholder="Reason For Leaving"  value="" class="form-control">
					</div>
				  </div>
				  ...
				  <div class="col-md-3">	
					...
					<label>Class In which Leaving</label>
					  <input type="text"  name="tc_student_class_leaving" id="tc_student_class_leaving" placeholder="Class In which Leaving"  value="" class="form-control" readonly>
