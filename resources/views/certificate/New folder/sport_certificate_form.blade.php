<script type="text/javascript">
   function fill_detail(value){
    ...
    loader();
        $.ajax({
            url: access_link+"certificate/sport_certificate_form_api.php",
            type: "POST",
            data: formdata,
   ...
   <section class="content-header">
      ...
      <li class="active">Sports Certificate Form</li> </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title">Sports certificate Generate</h3>
            </div>
            <!-- /.box-header -->
			 ...
			 <div class="col-md-6 ">				
					<div class="form-group" >
			          ...
			          <div class="col-md-3 ">
						<div class="form-group">
						  <label>student Name</label>
						   <input type="text"  name="sport_student_name" value="" placeholder="student Name"   id="student_name" class="form-control" readonly>
					       </div>
					  </div>
					  ...
					  <div class="col-md-3 ">	
						  ...
						  <input type="text" name="sport_student_roll_no"  value="" placeholder="Student Roll No"  id="school_roll_no" class="form-control" readonly>
					      </div>
				      </div>
				     ...
				     <div class="col-md-3 ">	
						<div class="form-group" >
						 <label> Sports Type</label>
						  <input type="text"  name="sport_type" placeholder="Sports Type"  value="" class="form-control" required>
						</div>
					  </div>
					  ...
					  <div class="col-md-3 ">	
						<div class="form-group" >
						 <label>Organized Date</label>
						  <input type="date"  name="sport_organized_date" id="date_of_school_leaving" placeholder="Organized Date"  value="" class="form-control" required>
						</div>
					  </div>
				      ...
				      <div class="col-md-3 ">	
					    <div class="form-group" >
					    <label> Rank </label>
					     <input type="text"  name="sport_rank" placeholder="Rank "  value="" class="form-control" required>
					   </div>
				     </div>
