...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Character Certificate Form</li>
    </ol>
</section>
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="character_student_name" value="" placeholder="student Name"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="character_student_father_name" id="student_father_name"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="character_student_roll_no" value="" placeholder="Student Roll No"
                                id="school_roll_no" class="form-control" readonly>
                            <input type="hidden" name="student_roll_no" value="" placeholder="Student Roll No"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="character_school_name" value="SIMPTION TECH PVT LTD"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="character_current_year_from" class="form-control"
                                        placeholder="From" required />
                                </div>

                                <div class="col-sm-6">

                                    <input type="text" class="form-control" name="character_current_year_to"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="character_type" placeholder="Character Type" value=""
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="character_issue_date" placeholder="Issued Date" value=""
