...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/event_certificate_list')}}"><i class="fa fa-certificate"></i> Event Certificate List</a>
        </li>
        <li class="active">Edit Event Certificate Form</li>
    </ol>
</section>
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="event_student_name" value="Rajesh Prasad"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="event_student_roll_no" value="2000314"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="event_type" placeholder="event Type" value="sports"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="event_organized_date" id="date_of_school_leaving"
                                placeholder="Organized  Date" value="2022-12-31" class="form-control">
                        </div>
                    </div>
