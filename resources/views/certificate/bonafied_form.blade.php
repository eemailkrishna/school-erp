                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="bonafied_student_name" value="" placeholder="student Name"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="bonafied_student_father_name" id="student_father_name"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="bonafied_student_roll_no" value="" placeholder="Student Roll No"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="bonafied_type" placeholder="Bonafied Type" value=""
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="bonafied_issue_date" placeholder="Issued Date" value=""
                                class="form-control" required>
                        </div>
                    </div>
