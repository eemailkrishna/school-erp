...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Sports Certificate Form</li>
    </ol>
</section>
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="sport_student_name" value="" placeholder="student Name"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="sport_student_roll_no" value="" placeholder="Student Roll No"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="sport_type" placeholder="Sports Type" value="" class="form-control"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="sport_organized_date" id="date_of_school_leaving"
                                placeholder="Organized Date" value="" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            <label> Rank </label>
                            <input type="text" name="sport_rank" placeholder="Rank " value="" class="form-control"
                                required>
                        </div>
                    </div>
