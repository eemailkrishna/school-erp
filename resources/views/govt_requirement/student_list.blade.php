...
function for_student() {
    ...
    $.ajax({
        type: "POST",
        url: access_link + "govt_requirement/ajax_student_list.php?student_class1=" + student_class1 +
            "&student_class_section1=" + student_class_section1 + "&religion=" + religion + "&gender=" +
            gender + "&categories=" + categories + "&regular=" + regular + "&handicapped=" + handicapped +
            "&govt=" + govt + "",
        cache: false,
        success: function(detail) {
            //alert_new(detail);
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-body ">
                <form method='post' action="../school_software_v1_old/pdf/pdf/govt_requirement/student_list_pdf.php"
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <label>Filter </label>
                                    <select name="student_class" onchange="for_filter(this.value);for_student();"
                            ...
                            <div class="col-md-6" id="religion_filter" style="display:none">
                                <div class="form-group">
                                    ...
                                    <select name="student_class" onchange="for_class(this.value);for_student();"
                            ...
                            <div class="col-md-6 " id="handicapped_filter" style="display:none">
                                <div class="form-group">
                                    <label>Filter Type</label>
                                    <select name="student_class" onchange="for_class(this.value);" id="handicapped"
                                        class="form-control">
                                        <option value="">Select Student</option>
                        ...
                        <div class="col-md-12" id="class_and_section" style="display:none">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Class</label>
                                    <select name="class" onchange="for_section(this.value);for_student();"
                                        id="student_class1" class="form-control" required>
                            ...
                            <div class="col-md-2 ">
                                <div class="form-group">
                                    <label>Section</label>
                                    <select class="form-control" name="section" onchange="for_student();"
                                        id="student_class_section1">
                                        <option value="All">All</option>
