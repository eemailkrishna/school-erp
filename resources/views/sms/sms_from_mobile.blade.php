    ...
    <div class="row">
        ...
        <div class="col-md-5">
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_1" onclick="checkdAll(1);"
                                value="">&nbsp;&nbsp;&nbsp;NURSERY[A]<span style='color:red'>[Student Count: 19]</span>
                        </h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_6" onclick="checkdAll(6);"
                                value="">&nbsp;&nbsp;&nbsp;LKG[A]<span style='color:red'>[Student Count: 15]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_8" onclick="checkdAll(8);"
                                value="">&nbsp;&nbsp;&nbsp;UKG[A]<span style='color:red'>[Student Count: 42]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_12" onclick="checkdAll(12);"
                                value="">&nbsp;&nbsp;&nbsp;1ST[A]<span style='color:red'>[Student Count: 12]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_14" onclick="checkdAll(14);"
                                value="">&nbsp;&nbsp;&nbsp;2ND[A]<span style='color:red'>[Student Count: 55]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_15" onclick="checkdAll(15);"
                                value="">&nbsp;&nbsp;&nbsp;3RD[A]<span style='color:red'>[Student Count: 9]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_16" onclick="checkdAll(16);"
                                value="">&nbsp;&nbsp;&nbsp;4TH[A]<span style='color:red'>[Student Count: 14]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_18" onclick="checkdAll(18);"
                                value="">&nbsp;&nbsp;&nbsp;5TH[A]<span style='color:red'>[Student Count: 13]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_20" onclick="checkdAll(20);"
                                value="">&nbsp;&nbsp;&nbsp;6TH[A]<span style='color:red'>[Student Count: 12]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_23" onclick="checkdAll(23);"
                                value="">&nbsp;&nbsp;&nbsp;7TH[A]<span style='color:red'>[Student Count: 18]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_24" onclick="checkdAll(24);"
                                value="">&nbsp;&nbsp;&nbsp;8TH[A]<span style='color:red'>[Student Count: 29]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_25" onclick="checkdAll(25);"
                                value="">&nbsp;&nbsp;&nbsp;9TH[A]<span style='color:red'>[Student Count: 6]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_27" onclick="checkdAll(27);"
                                value="">&nbsp;&nbsp;&nbsp;10TH[A]<span style='color:red'>[Student Count: 1]</span></h3>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_28" onclick="checkdAll(28);"
                                value="">&nbsp;&nbsp;&nbsp;11TH[SCIENCE][A]<span style='color:red'>[Student Count:
                                4]</span></h3>
            ...
            <div class="col-md-12">
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_30" onclick="checkdAll(30);"
                                value="">&nbsp;&nbsp;&nbsp;11TH[Commerce ][A]<span style='color:red'>[Student Count:
                                1]</span></h3>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <div class="box-body" style="color:teal;">
                                    &nbsp;&nbsp;&nbsp;<input type="checkbox" name="" onclick="myContact(30);"
                                        class="check_30 checked_contact" value="7498177242">&nbsp;&nbsp;&nbsp;SARIKA
                                    SULTANE (7498177242)<br>
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_31" onclick="checkdAll(31);"
                                value="">&nbsp;&nbsp;&nbsp;12TH[SCIENCE][A]<span style='color:red'>[Student Count:
                                1]</span></h3>
            ...
            <div class="col-md-12">
                <div class="box box-default collapsed-box my_border_top" style="border-radius:20px;">
                    <div class="box-header with-border ">
                        <h3 class="box-title"><input type="checkbox" name="" id="checkbox_33" onclick="checkdAll(33);"
                                value="">&nbsp;&nbsp;&nbsp;12TH[Commerce ][A]<span style='color:red'>[Student Count:
                                1]</span></h3>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <div class="box-body" style="color:teal;">
                                    &nbsp;&nbsp;&nbsp;<input type="checkbox" name="" onclick="myContact(33);"
                                        class="check_33 checked_contact" value="8059076999">&nbsp;&nbsp;&nbsp;Ravi
                                    (8059076999)<br>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="box box-info my_border_top">
                ...
                <form method="post" enctype="multipart/form-data" onsubmit="return validateForm();" id="my_form">
                    <div class="box-body">
                        ...
                        <div class="col-md-12 ">
                            <center><input type="button" name="submit1" value="Send" onclick="send_mobile_sms()"
