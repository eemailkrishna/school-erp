   ...
   <section class="content">
       <div class="box">
           ...
           <div class="box-body">
               <a href="javascript:get_content('sms/student_sms')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#808000;">
                           ...
                           <a href="javascript:get_content('sms/student_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="{{url('sms/holiday_sms')}}">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:#800080;">
                           ...
                           <a href="{{url('sms/holiday_sms')}}" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="{{url('sms/birthday_sms')}}">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#008080;">
                           ...
                           <a href="{{url('sms/birthday_sms')}}" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="{{url('sms/student_notification')}}">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#008000;">
                           ...
                           <a href="{{url('sms/student_notification')}}" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="{{url('sms/message_list')}}">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#800000;">
                           ...
                           <a href="{{url('sms/message_list')}}" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="{{url('sms/sms_from_mobile')}}">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#000080;">
                           ...
                           <a href="{{url('sms/sms_from_mobile')}}" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/classwise_sms')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#808080;">
                           ...
                           <a href="javascript:get_content('sms/classwise_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/staff_sms')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#3B3B6D;">
                           ...
                           <a href="javascript:get_content('sms/staff_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/attendance_sms')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#9F2B68;">
                           ...
                           <a href="javascript:get_content('sms/attendance_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/fee_sms')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#34B334;">
                           ...
                           <a href="javascript:get_content('sms/fee_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="javascript:get_content('sms/sms_templates_list')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:	#804040;">
                           ...
                           <a href="javascript:get_content('sms/sms_templates_list')" class="small-box-footer">More Info
               ...
               <a href="javascript:get_content('sms/add_group')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#1A47F0;">
                           ...
                           <a href="javascript:get_content('sms/add_group')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/add_group_staff')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#1A47F0;">
                           ...
                           <a href="javascript:get_content('sms/add_group_staff')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="javascript:get_content('sms/group_student')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#A481CB;">
                           ...
                           <a href="javascript:get_content('sms/group_student')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               ...
               <a href="javascript:get_content('sms/group_teacher')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#3B7A57;">
                           ...
                           <a href="javascript:get_content('sms/group_teacher')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/group_wise_sms')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:	#C46210;">
                           ...
                           <a href="javascript:get_content('sms/group_wise_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="{{url('sms/delivery_report')}}">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#C46210;">
                           <div class="inner"><br>
                           ...
                           <a href="{{url('sms/delivery_report')}}" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/bus_sms')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#34B334;">
                           ...
                           <a href="javascript:get_content('sms/bus_sms')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/group_other')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#3B7A57;">
                           ...
                           <a href="javascript:get_content('sms/group_other')" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
               <a href="javascript:get_content('sms/voice_call_panel')">
                   <div class="col-lg-3 col-xs-6" style="display:none">
                       <div class="small-box" style="background-color:#82700E;">
                           ...
                           <a href="javascript:get_content('sms/voice_call_panel')" class="small-box-footer">More Info
                               <i class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
       ...
       <div class="box">
           ...
           <div class="box-body">
               ...
               <a href="{{('sms/delivery_print_report')}}">
                   <div class="col-lg-3 col-xs-6">
                       <div class="small-box" style="background-color:	#C46210;">
                           <div class="inner"><br>
                           ...
                           <a href="{{('sms/delivery_print_report')}}" class="small-box-footer">More Info <i
                                   class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
               </a>
