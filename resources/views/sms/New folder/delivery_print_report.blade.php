...
$.ajax({
	  type: "POST",
	  url: access_link+"sms/ajax_delivery_print_report.php?from_date="+from_date+"&to_date="+to_date+"&order_by="+order_by+"",
	  cache: false,
 ...
 newWin.close();
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('sms/sms_panel')"><i class="fal fa-comment-alt"></i> SMS Panel</a></li>
