	                ...
	                <div class="box box-default collapsed-box">
	                    <table id="search_table">
	                        <div class="box-header with-border">
	                            ...
	                            <select class="form-control select2 multiple_class" multiple="multiple" id="multiple"
	                ...
	                <div class="box box-default collapsed-box">
	                    ...
	                    <table class="table  ">
	                        <thead class="my_background_color">
	                            <tr>
	                                <th><input type="checkbox" name="" id="checkboxstudent"
	                                        onclick="checkCheckedAllStudent();myStudentstaff();"
	                                        value="">&nbsp;&nbsp;&nbsp;All Student List</th>
	                            </tr>
	                        </thead>
	                        <tbody>
	                            ...
	                            <tr>
	                                <td style="color:red"><input type="checkbox" name="" onclick="myStudentstaff();"
	                                        value="546123790">&nbsp;&nbsp;&nbsp;shikha (546123790)[2011-12-05]</td>
	                            </tr>
	                ...
	                <div class="box box-default collapsed-box">
	                    <table id="search_table">
	                        <div class="box-header with-border">
	                            ...
	                            <select class="form-control select2 multiple_class" multiple="multiple" id="multiple4"
	                                data-placeholder=" Search by name..." onchange="search_contact()" style="width: 100%;">
	            ...
	            <div class="col-md-12">
	                <div class="box box-default collapsed-box">
	                    <table class="table  ">
	                        <thead class="my_background_color">
	                            <tr>
	                                <th><input type="checkbox" name="" id="checkboxstaff"
	                                        onclick="checkCheckedAllStaff();myStudentstaff();"
	                                        value="">&nbsp;&nbsp;&nbsp;All Staff List</th>
	                            </tr>
	                        </thead>
	                        <tbody>
	                            ...
	                            <tr>
	                                <td style="color:red"><input type="checkbox" name="" onclick="myStudentstaff();"
	                                        value="4454655y6547">&nbsp;&nbsp;&nbsp;Supriya
	                                    Santosh(4454655y6547)[2019-12-05]</td>
	                            </tr>
