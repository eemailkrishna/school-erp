             ...
             <a href="{{url('/complaint-studentComplaint')}}">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#E32636;">
                         ...
                         <a href="javascript:get_content('complaint/student_complaint')" class="small-box-footer">More
             ...
             <a href="{{url('/complaint-staffFeedback')}}">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#3B7A57;">
                         ...
                         <a href="javascript:get_content('complaint/staff_complaint')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
             <a href="{{url('/complaint-employeeComplaints')}}">
                 <div class="col-lg-3 col-xs-6">
                     <div class="small-box" style="background-color:#7a7b7b;">
                         ...
                         <a href="javascript:get_content('complaint/faculty_complaint')" class="small-box-footer">More
                             Info <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
             </a>
