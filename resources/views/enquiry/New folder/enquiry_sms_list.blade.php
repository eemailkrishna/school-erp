      ...
      <div class="row">
        ...
        <div class="col-md-2">	
         <div class="form-group" >
          ...
          <input type="date" value="2022-12-03" name="from_date" id="from_date" oninput="for_feelist();" class="form-control" />
         </div>
        </div>
        ...
        <div class="col-md-2">	
         <div class="form-group" >
          <label>To Date</label>
          <input type="date" value="2022-12-03" name="to_date" id="to_date" oninput="for_feelist();" class="form-control" />
         </div>
        </div>
		...
		<div class="col-md-6">	
         <div class="form-group" >
          ...
          <textarea name="message_content" class="form-control">Welcome to our School. Regards - SIMPTION TECH PVT LTD For more detail - 9074822542 [SCHOOL]</textarea>
         </div>
        </div>
