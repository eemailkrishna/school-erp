...
function for_list() {
    ...
    if (enquiry_from_date != '' && enquiry_to_date != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "enquiry/ajax_enquiry_daily_report.php?enquiry_type=" + enquiry_type +
                "&enquiry_medium=" + enquiry_medium + "&enquiry_from_date=" + enquiry_from_date +
                "&enquiry_to_date=" + enquiry_to_date + "&enquiry_order_by=" + enquiry_order_by + "",
            cache: false,
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/enquiry')}}"><i class="fa fa-phone-square"></i> Enquiry</a></li>
                ...
                <div class="col-md-12 col-md-offset-1" id="search_detail">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="enquiry_medium" id="enquiry_medium" class="form-control"
                                onchange="for_list();">
                                <option value="All">All</option>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="date" name="enquiry_from_date" id="enquiry_from_date" value="2022-12-03"
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="date" name="enquiry_to_date" id="enquiry_to_date" value="2022-12-03"
                                class="form-control" oninput="for_list();" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="enquiry_order_by" id="enquiry_order_by"
                                onchange="for_list();">
                                ...
                                <option value=" ORDER BY enquiry_next_follow_up_date ASC">By Enquiry Next Follow Up Date
                                </option>
                            </select>
                        </div>
                    </div>
