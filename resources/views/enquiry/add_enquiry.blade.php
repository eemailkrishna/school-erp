                ...
                <form role="form" method="post" id="my_form" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4" id="div_enquiry_type_ohter">
                        <div class="form-group">
                            ...
                            <input type="text" value="" name="enquiry_type_ohter" id="enquiry_type_ohter" value=""
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="enquiry_contact_no_1" placeholder="Contact No 1." value=""
                                class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="enquiry_contact_no_2" placeholder="Contact No 2." value=""
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4 ">
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="blank_field_2" placeholder="Previous School Name" value=""
                                class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-4 ">
