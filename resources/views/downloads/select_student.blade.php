                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="student_class_stream"
                                    id="student_class_stream" onchange="get_group(this.value);" style="width:100%;">
                                    <option value="All">All</option>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input style="width:100%;" type="range" name="student_age" id="student_age" value="0"
                                    oninput="for_age(this.value,this.id,'student_age_txt');">
                                <span class="input-group-addon" style="padding:0px;">
                                    <input style="color:red;font-size:20px;width:100px;" name="student_age_txt"
                                        id="student_age_txt" oninput="for_age(this.value,this.id,'student_age');"
                                        style="border:none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-control select2" name="student_religion" id="student_religion"
                                style="width:100%">
                                <option value="All">All</option>
                    ...
                    <div class="col-md-2 ">
                        <div class="form-group">
                            <input type="checkbox" checked name="student_data[]"
                                value="student_religion|?|student religion" class="check_all">
                    ...
                    <div class="col-md-2 ">
                        <div class="form-group">
                            <input type="checkbox" checked name="student_data[]"
                                ...
                                class="check_all">
                            <th><b>Student Father Number2</b></th>
                        </div>
                    </div>
                    <div class="col-md-2 ">
                        <div class="form-group">
