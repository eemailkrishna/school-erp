          ...
          <div class="box box-primary my_border_top">
              ...
              <div class="box-body ">
                  <form role="form" method="post" enctype="multipart/form-data" id="my_form1">
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                              <input type="checkbox" checked name="student_data[]" value="enquiry_type|?|enquiry type"
                                  class="check_all">
                      ...
                      <div class="col-md-2 ">
                          <div class="form-group">
                              <input type="checkbox" checked name="student_data[]" value="enquiry_date|?|enquiry date"
                                  class="check_all">
                      ...
                      <div class="col-md-2 ">
                          <div class="form-group">
                              <input type="checkbox" checked name="student_data[]" value="enquiry_name|?|enquiry name"
                                  class="check_all">
                              <th><b>Enquiry Name</b></th>
                          </div>
                      </div>
                      <div class="col-md-2 ">
                          <div class="form-group">
                              <input type="checkbox" checked name="student_data[]"
                                  value="enquiry_father_name|?|enquiry father name" class="check_all">
                              <th><b>Enquiry Father Name</b></th>
                          </div>
                      </div>
                      <div class="col-md-2 ">
                          <div class="form-group">
                              <input type="checkbox" checked name="student_data[]"
                                  value="enquiry_contact_no_1|?|enquiry contact no 1" class="check_all">
                              <th><b>Enquiry Contact No 1</b></th>
                          </div>
                      </div>
                      <div class="col-md-2 ">
                          <div class="form-group">
                              <input type="checkbox" checked name="student_data[]"
                                  value="enquiry_contact_no_2|?|enquiry contact no 2" class="check_all">
                              <th><b>Enquiry Contact No 2</b></th>
                          </div>
                      </div>
                      <div class="col-md-2 ">
                          <div class="form-group">
                              <input type="checkbox" checked name="student_data[]"
                                  value="enquiry_address|?|enquiry addresss" class="check_all">
                              <th><b>Enquiry Address</b></th>
                          </div>
                      </div>
                      <div class="col-md-2 ">
                          <div class="form-group">
                              <input type="checkbox" checked name="student_data[]"
                                  value="enquiry_next_follow_up_date|?|enquiry next follow up date" class="check_all">
                              <th><b>Enquiry Next Follow Up Date</b></th>
                          </div>
                      </div>
