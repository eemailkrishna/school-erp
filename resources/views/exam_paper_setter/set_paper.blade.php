...
function for_question() {
    ...
    if (s_class != '' && subject != '' && chapter != '' && value != '' && language != '') {
        $.ajax({
            address: "POST",
            url: access_link + "exam_paper_setter/ajax_select_book_name.php?s_class=" + s_class + "&subject=" +
                subject + "&chapter=" + chapter + "&q_type=" + value + "&language=" + language + "",
            cache: false,
            success: function(detail) {
    ...
    if (page_name != '' && exam_type != '' && chapter != '' && book != '' && language != '') {
        ...
        $.ajax({
            ...
            url: access_link + "exam_paper_setter/" + page_name + "?s_class=" + s_class + "&subject=" +
                subject + "&chapter=" + chapter + "&book=" + book + "&language=" + language + "",
            cache: false,
            success: function(detail) {
...
$(document).ready(function() {
    ...
    if (s_class != '' && subject != '' && exam_type != '' && id != '' && language != '') {
        $.ajax({
            address: "POST",
            url: access_link + "exam_paper_setter/ajax_get_paper_set_list.php?s_class=" + s_class +
                "&subject=" + subject + "&exam_type=" + exam_type + "&id=" + id + "&language=" +
                language + "",
            cache: false,
            success: function(detail) {
...
function for_unique(value) {
    if (value != '') {
        if (value == 'old') {
            ...
            $("#text_select").html(
                "<label >Unique Id</label><input type='text' name='paper_unique_id' class='form-control' placeholder='Enter Unique Id' id='paper_unique_id' required />"
            );
        }
    } else {
        $("#text_select").empty();
...
$(document).ready(function() {
    ...
    var language = document.getElementById('language').value;
    if (value != '' && language != '') {
        $("#for_edit_button").html("<a href=" + access_link + "'exam_paper_setter/paper_edit.php?id=" + value +
            "&language=" + language +
            "'><button type='button' class='btn btn-default btn-md' id='paper_edit' >Edit Paper</button></a>"
        );
    } else {
...
$("#my_form").submit(function(e) {
    ...
    var new_data = "u_id=" + paper_unique_id + "&class=" + s_class + "&subject=" + subject + "&e_type=" +
        exam_type + "&language=" + language + "&book_name=" + book_name;
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/exam_paper_setter')}}"><i class="fa fa-scribd" aria-hidden="true"></i>Exam Paper Setter</a>
        </li>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Old / New</label>
                                <input type="text" name='paper_type' id="paper_type" value="old" class='form-control'
                                    readonly />
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="form-group" id="text_select">
                                ...
                                <input type="text" name='paper_unique_id' id="paper_unique_id"
                                    value="1ST_computer_objective_25_08_2021_English" class='form-control' readonly />
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Class</label>
                                <input type="text" name='question_class' id="question_class" value="1ST"
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Subject</label>
                                <input type="text" name='question_subject' id="question_subject" value="computer"
                                    class='form-control' readonly />
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 ">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name='question_exam_type' id="question_exam_type" value="objective"
                                    class='form-control' readonly />
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 ">
                        ...
                        <div class="col-md-5">
                            <div class="col-md-4">
                                <center><button type="button" class="btn btn-warning btn-md" id="timmings"
                                        onclick="for_detail();" data-toggle="modal" data-target="#myModal" disabled>Add
                                        Schedule</button></center>
                            </div>
                            <div class="col-md-4">
                                <a href="javascript:get_content('exam_paper_setter/instructions_edit')"><button
                                        type="button" class="btn btn-primary btn-md" id="">Instructions</button></a>
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="total_question" id="total_question" class="form-control"
                                    readonly />
                                <input type="hidden" name="total_question_marks" id="total_question_marks"
                                    class="form-control" readonly />
                    ...
                    <div class="col-md-12 ">
                        <center>
                            <button type="button" id="add_in_paper" class="btn btn-success"
                                onclick="get_submit_type('submit');" disabled>Add In Question
                                Paper</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" id="or_question"
                                onclick="get_submit_type('submit2');" class="btn btn-success" disabled>Add Or
                                Question</button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="exam_date" id="" value="2022-12-05" class="form-control" />

                                <input type="hidden" name="question_class1" id="question_class1" value=""
                                    class="form-control" />
                                <input type="hidden" name="question_subject1" id="question_subject1" value=""
                                    class="form-control" />
                                <input type="hidden" name="question_exam_type1" id="question_exam_type1" value=""
                                    class="form-control" />
                                <input type="hidden" name="paper_unique_id1" id="paper_unique_id1" value=""
                                    class="form-control" />
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" name="exam_time_from" id="" value="17:18" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" name="exam_time_to" id="" value="17:18" class="form-control" />
                            </div>
                        </div>
                    </div>
