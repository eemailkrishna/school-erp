                ...
                <div class="col-md-1">	
				 ...
				 <div class="col-md-5">				
					<div class="form-group" id="text_select" >
						...
						<input type="text" name='paper_unique_id' id="paper_unique_id" value="10TH_Social Science_first_19_04_2020_English" class='form-control' readonly />
					</div>
				 </div>	
				<div class="col-md-5">				
					 <div class="form-group" >
					    <label>Class</label>
						<input type="text" name='question_class' id="question_class" value="10TH" class='form-control' readonly />
					</div>
				</div>				 
			...
			<div class="col-md-12">
                ...
                <div class="col-md-1">	
				 ...
				 <div class="col-md-5">				
					 <div class="form-group" >
					  <label>Subject</label>
					  <input type="text" name='question_subject' id="question_subject" value="Social Science" class='form-control' readonly />
					</div>
				 </div>				 
				 			<div class="col-md-5">				
					 <div class="form-group" >
					  <label>Exam Type</label>
					  <input type="text" name='question_exam_type' id="question_exam_type" value="first" class='form-control' readonly />
					</div>
				</div>
			 </div>
			 			 <div class="col-md-12 ">
                ...
                <div class="col-md-1">	
					 ...
					 <div class="form-group" >
					  ...
					  <input type="text"  id="new_book_input" name="question_book_input" value="" style="display:none" placeholder="Enter Question Book Name" class="form-control" />
				...
				<div class="col-md-5">				
				 ...
				 <div class="col-md-4">				
					<div class="form-group" >
					  ...
					  <input type="text" name="language" id="language" class="form-control" value="English" readonly />
					</div>
				 </div>				 
		  ...
		  <div class="col-md-12">
				...
				<div class="col-md-4">				
					 <div class="form-group" >
						...
						<input type="hidden" name="paper_unique_id1" id="paper_unique_id1" value="10TH_Social Science_first_19_04_2020_English" class="form-control" />
					</div>
				</div>
