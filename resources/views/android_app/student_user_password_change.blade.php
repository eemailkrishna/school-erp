...
function for_section() {
    ...
    $.ajax({
        type: "POST",
        url: access_link + "android_app/ajax_class_section.php?class_name=" + class_name + "",
        cache: false,
...
function attendance_list() {
    ...
    if (class_name != '' && class_section != '' && t == 1) {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "android_app/ajax_student_password_update.php?class_name=" + class_name +
...
function get_group(value1) {
    $("#student_class_group").html(loader_div);
    $.ajax({
        type: "POST",
        url: access_link + "android_app/ajax_stream_group.php?stream_name=" + value1 + "",
        cache: false,
...
$("#my_form").submit(function(e) {
    ...
    loader();
    $.ajax({
        url: access_link + "android_app/student_user_password_change_api.php",
        type: "POST",
        data: formdata,
        ...
        success: function(detail) {
            ...
            if (res[1] == 'success') {
                ...
                get_content('android_app/student_user_password_change');
            }
        }
    });
});
