    ...
    <div class="col-md-12">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select name="homework_class" onchange="for_section(this.value);for_subject();for_stream(this.value)"
                    id="homework_class" class="form-control" required>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label>Date</label>
                <input type="date" value="2022-12-05" name="homework_date" id="myLocalDate" placeholder="Date" value=""
                    class="form-control">
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body pad">
                ...
                <textarea id="" name="homework" class="form-control bordder-color" placeholder="write homework"
