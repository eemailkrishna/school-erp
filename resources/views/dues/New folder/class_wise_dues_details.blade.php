      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box" id="printTable">
			...
			<div class="col-sm-12">
			<div class="col-sm-4">
			<h5 class="my_background_color" style="padding:10px 10px 10px 10px;"><center>NURSERY /  Class Fee Total Amount :-  484918.00</center></h5>
			</div>
			<div class="col-sm-4">
			<h5 class="my_background_color" style="padding:10px 10px 10px 10px;"><center>NURSERY /  Class Paid Total Amount :-  14590.00</center></h5>
			</div>
			<div class="col-sm-4">
			<h5 class="my_background_color" style="padding:10px 10px 10px 10px;"><center>NURSERY /  Class Dues Total Amount :-  470368.00</center></h5>
			</div>
			</div>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="printTable" border="1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="text-align:center;">45668</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2200782')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">40800</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2200785')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">52800</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2200790')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2200793')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">32900</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2200795')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">35800</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2200800')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">31200</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2200823')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">48000</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2200884')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">0</td>
                  <td style="text-align:center;">11900</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2201009')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">12900</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2201039')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">52000</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2201041')" class="btn btn-primary">Details</button></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">41150</td>
                  <td style="text-align:center;">0</td>               
                  <td><button type="button" onclick="post_content('fees_monthly/student_fee_list_particular','student_roll_no=2201086')" class="btn btn-primary">Details</button></td>
                </tr>
                                </tbody>
             </table>
