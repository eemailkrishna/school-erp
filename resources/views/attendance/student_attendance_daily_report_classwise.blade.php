...
function for_list() {
    ...
    if (class_name != '' && section_name != '' && from_date != '' && to_date != '') {
        ...
        if (frm_date1[0] == to_date1[0] && frm_date1[1] == to_date1[1]) {
            ...
            $.ajax({
                type: "POST",
                url: access_link + "attendance/ajax_student_attendance_daily_report_classwise.php?class_name=" +
                    class_name + "&section_name=" + section_name + "&from_date=" + from_date + "&to_date=" +
                    to_date + "",
                cache: false,
                success: function(detail) {
