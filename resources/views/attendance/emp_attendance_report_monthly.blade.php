...
function for_list() {
    ...
    if (staff_type != '' && attendance_month != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "attendance/ajax_emp_attendance_report_monthly.php?staff_type=" + staff_type +
                "&attendance_month=" + attendance_month + "&order_by=" + order_by + "",
            cache: false,
                ...
                <div class="col-md-12 col-md-offset-3" id="search_detail">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="staff_type" id="staff_type" class="form-control" onchange="for_list();"
                                required>
