...
<center><button type="button" class="btn default" onclick="for_print();"><i class="fa fa-print" aria-hidden="true"></i>Print In Pdf</button></center>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success ">
			...
			<td><center><b>Month : December</b></center></td>
			<td style="float:right"><b>Category : All</b></td>
				  ...
				  <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
					...
					<td><span style="font-weight:bold;">360</span></td>
					<td><span style="font-weight:bold;">2712</span></td>
					<!--<td><span style="font-weight:bold;"></span></td>-->
					</tr>
					</tfoot>
				 </table>
        ...
        <!-- /.col -->
			  ...
			  <div class="col-md-12">
			  <div class="col-md-6">
			  <center><button type="button" class="btn btn-success" onclick="exportTableToExcel('printTable', 'Employeewise Attendance Report Monthly')"><i class="fa fa-print" aria-hidden="true"></i>  Print In Excel</button></center>
			  </div>
			  <div class="col-md-6">
