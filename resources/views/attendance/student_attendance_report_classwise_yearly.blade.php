    ...
    <div class="row">
        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12"><span style="float:right;font-weight:bold;color:red;"><input type="checkbox"
                            name="" id="my_month" onclick="for_check(this.id);" /> All</span></div>
                <div class="col-md-12">
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="04" class="my_month" onclick="for_list();" /> April
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="05" class="my_month" onclick="for_list();" /> May
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="06" class="my_month" onclick="for_list();" /> June
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="07" class="my_month" onclick="for_list();" /> July
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="08" class="my_month" onclick="for_list();" /> August
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="09" class="my_month" onclick="for_list();" /> September
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="10" class="my_month" onclick="for_list();" /> October
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="11" class="my_month" onclick="for_list();" /> November
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="12" class="my_month" onclick="for_list();" /> December
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="01" class="my_month" onclick="for_list();" /> January
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="02" class="my_month" onclick="for_list();" /> February
                    </div>
                    <div class="col-md-2">
                        <input type="checkbox" name="" value="03" class="my_month" onclick="for_list();" /> March
                    </div>
                </div>
