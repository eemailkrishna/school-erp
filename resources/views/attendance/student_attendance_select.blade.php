...
function attendance_list() {
    ...
    if (class_name != '' && class_section != '' && t == 1) {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "attendance/ajax_attendance_search.php?class_name=" + class_name +
...
function fill_attendance() {
    ...
    if (class_name != '' && class_section != '' && t == 1) {
        var data12 = "attendance_student_class=" + class_name + "&attendance_student_date=" + attendance_student_date +
            ...
            <div class="box box-success " style="padding:10px 10px 10px 10px;">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="attendance_student_date"
                            id='attendance_student_date' max="2022-12-03" min="2020-03-08" value="2022-12-03">
                    </div>
                    <div class="form-group">
                        <center><button type="submit" name="fill" onclick="fill_attendance();"
                                class="btn btn-success">Fill Attendance</button>
                            <button type="submit" name="view" onclick="view_attendance();" class="btn btn-success">View
                                Attendance </button>
                        </center>
                    </div>
