...
function for_list() {
    ...
    if (class_name != '' && section_name != '' && attendance_month != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "attendance/ajax_student_attendance_report_classwise_monthly.php?class_name=" +
                class_name + "&section_name=" + section_name + "&attendance_month=" + attendance_month +
                "&order_by=" + order_by + "",
            cache: false,
            success: function(detail) {
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{('/attendance')}}"><i class="fa fa-child"></i> Attendance</a></li>
            ...
            <div class="box-body">
                ...
                <div class="col-md-12 col-md-offset-2" id="search_detail">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>Month</label>
                            <select name="attendance_month" id="attendance_month" class="form-control"
                                onchange="for_list();">
