                    ...
                    <div class="box-body table-responsive">
                        <div class="form-group">
                            ...
                            <select name="staff_type" id="staff_type" class="form-control"
                                onchange="emp_attendance(this.value);" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id='staff_attendance_date'
                                name="staff_attendance_date" max="2022-12-03" min="2020-03-08" value="2022-12-03">
                        </div>
                        <div class="form-group">
                            <center><button type="button" onclick="fill_attendance();" class="btn btn-success">Fill
                                    Attendance</button>
                                <button type="button" name="view" onclick="view_attendance();"
                                    class="btn btn-success">View Attendance</button>
                            </center>
                        </div>
