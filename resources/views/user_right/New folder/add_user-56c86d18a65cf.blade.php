...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			 ...
			 <div class="col-md-4 ">
						<div class="form-group">
						  <label>User Name</label>
						   <input type="text"  name="user_name"  id='user_name' placeholder="User Name"  value="Rashi Saxena" class="form-control " required />
						</div>
			</div>
				 ...
				 <div class="col-md-4 ">
						<div class="form-group">
						  <label>Email</label>
						   <input type="email"  name="user_email"  id='user_email' placeholder="Email"  value="rashisaxena1997@gmail.com" class="form-control " required readonly />
						</div>
			</div>
				 <div class="col-md-4 ">
						<div class="form-group">
						  <label>Mobile</label>
						   <input type="text"  name="user_mobile"  id='user_mobile' placeholder="Mobile"  value="9630843846" class="form-control " required />
						</div>
			</div>
				 <div class="col-md-4 ">
						<div class="form-group">
						...
						<div class="form-group">
						  <label>Password</label>
						   <input type="text"  name="user_password"  id='user_password' placeholder="Password"  value="" class="form-control " required />
						</div>
			</div>
			</div>
		...
		<tbody>
                	<!-- /.Account start -->	
						 ...
						 <td  rowspan="3">1</td>
						 <td  rowspan="3">
						   <input type="checkbox"  name="panel_rights[]" id="panel_1" onclick="check_all_panel_wise('1')"  class="check_all_panel"  value="panel_account"/>
			              </td>
			              <td rowspan="3">
						  <label>Account</label>
			              </td>
			              ...
			              <td rowspan="3">
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1"   onclick="check_all_panel_wise_all('1')" value="sub_panel_add_account"   />
						  </td>
						  <td rowspan="3" >
						  ...
						  <td rowspan="3"><input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1"   onclick="check_all_panel_wise_all('1')" value="sub_panel_add_income_or_expence_info"   />
							  </td>
						  <td rowspan="3">
			                <label>Add Income Or Expence Info</label>
							 ...
							 <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1"   onclick="check_all_panel_wise_all('1')" value="sub_panel_ledger"   />
			                </td>
						  <td rowspan="3"><label>Ledger</label>
						 </td>
							   <td>
							<input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 " id="edit_delete_1"  onclick="check_all_panel_wise_all('1');check_edit_delete('1');" value="sub_panel_account_list"   /> </td>
						  <td>
			                <label>Account List</label>
						  </td>
						  <td >
							 
							 <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 "  id="edit_delete_2" onclick="check_all_panel_wise_all('1');check_edit_delete('2');" value="sub_panel_income_or_expence_list"   />
			                </td>
						  <td ><label>Income Or Expence List</label>
							 </td>
							 
						<td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 "  id="edit_delete_2" onclick="check_all_panel_wise_all('1');check_edit_delete('2');" value="account_sub_panel_ledger_report_daily"   />
			            </td>
						<td >
						 ...
						 <tr>
						  <td><input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 "   onclick="check_all_panel_wise_all('1');check_edit_delete_reverse('1','1')" id="edit_1" value="sub_panel_account_list_edit" />
			                 </td>
						  <td><label style="color:orange">Edit</label>
									   </td>
									     <td>
							 
							 <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 "   onclick="check_all_panel_wise_all('1');check_edit_delete_reverse('1','2')"  id="edit_2" value="account_panel_edit_button"   />
			                </td>
						  <td><label  style="color:orange">Edit</label>
							 </td>
						 </tr>
						 <tr>
						  ...
						  <td> <label style="color:red">Delete</label>
						    <td>
							 ...
							 <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 "  id="delete_2"  onclick="check_all_panel_wise_all('1');check_edit_delete_reverse('1','2')" value="account_panel_delete_button"   />
			                </td>
						  <td><label  style="color:red">Delete</label>
							 </td>
						 </tr>
						...
						<td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 "  id="edit_delete_2" onclick="check_all_panel_wise_all('1');check_edit_delete('2');" value="account_sub_panel_ledger_report_monthly"   />
			            </td>
						<td >
						 ...
						 <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 "  id="edit_delete_2" onclick="check_all_panel_wise_all('1');check_edit_delete('2');" value="account_sub_panel_income_expanece_report"   />
			            </td>
						<td >
					...
					<!-- /.Attedace start -->	 
					   ...
					   <input type="checkbox"  name="panel_rights[]" id="panel_3" onclick="check_all_panel_wise('3')"  class="check_all_panel"   value="panel_bus"   />
						...
						<tr>
						  ...
						  <td>
						     <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_3"   onclick="check_all_panel_wise_all('3')" value="bus_panel_edit_button"   />
						  </td>
						  <td>
						  ...
						  <td>
						     <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_3"   onclick="check_all_panel_wise_all('3')" value="bus_panel_delete_button"   />
						  </td>
						  <td>
						...
						<td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="Fess_panel_edit_button"   />
			            </td>
			            <td>
		...
		<tbody>
				  ...
				  <input type="checkbox"  name="3RD_section[] " class="check_all_class check_all_classwise6"  value="A"   onclick="class_wise_check_reverse('6');" />
				     <label>A</label>
                               ...
                               <tr>
                  <td>7</td>
                  <td> <input type="checkbox"  name="class_right[]" class="check_all_class" id="id_check_all_classwise7" onclick="class_wise_check('7');"  value="4TH"   />   <label>4TH</label></td>
				  <input type="hidden" name='section1[]' value="2" />
