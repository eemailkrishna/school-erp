...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<option selected value='rajanikanta.fine@gmail.com' >Pankajini Patra[8249570835]</option>
			<option selected value='rajanikanta.fine@gmail.com' >Jyoti Ranjan Patra[+917008251522]</option>
			<option selected value='rajanikanta.fine@gmail.com' >Goutam Kumar Das[+916371329608]</option>
			<option selected value='rajanikanta.fine@gmail.com' >Human Ram Bhati[8249570835]</option>
			<option selected value='rajanikanta.fine@gmail.com' >Premshankar Yadav[8249570835]</option>
			<option selected value='rajanikanta.fine@gmail.com' >Amit Kumar Patra[8249570835]</option>
			<option selected value='rajanikanta.fine@gmail.com' >Sibdutta Negi[9981229723]</option>
			 ...
			 <div class="col-md-4 ">
						<div class="form-group">
						  <label>User Name</label>
						   <input type="text"  name="user_name"  id='user_name' placeholder="User Name"  value="Puran Singh Sahu" class="form-control " required />
						</div>
			</div>
				 ...
				 <div class="col-md-4 ">
						<div class="form-group">
						  <label>Email</label>
						   <input type="email"  name="user_email"  id='user_email' placeholder="Email"  value="rajanikanta.fine@gmail.com" class="form-control " required readonly />
						</div>
			</div>
				 <div class="col-md-4 ">
						<div class="form-group">
						  <label>Mobile</label>
						   <input type="text"  name="user_mobile"  id='user_mobile' placeholder="Mobile"  value="+918815220143" class="form-control " required />
						</div>
			</div>
				 <div class="col-md-4 ">
						<div class="form-group">
						...
						<div class="form-group">
						  <label>Password</label>
						   <input type="text"  name="user_password"  id='user_password' placeholder="Password"  value="54321" class="form-control " required />
						</div>
			</div>
			</div>
		...
		<tbody>
                	<!-- /.Account start -->	
						...
						<td >
						 ...
						 <tr>
						 	  <td><input type="checkbox"     name="panel_rights[]" class="check_all_panel check_1 "   onclick="check_all_panel_wise_all('1');check_edit_delete_reverse('1','1')"  id="delete_1" value="sub_panel_account_list_delete"  />
			                 </td>
					...
					<!-- /.Attedace start -->	 
						<td>2</td>
						 <td>
						   <input type="checkbox"  name="panel_rights[]" id="panel_2" onclick="check_all_panel_wise('2')" checked class="check_all_panel"   value="panel_attendance"   />  </td>
						  <td>
			                  <label>Attendance</label>  </td>
						  <td>
							 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="sub_panel_student_attendance_select"   />  </td>
						  <td>
			                  <label>Student Attendance Select</label>  </td>
						  <td>
			                 
						 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="sub_panel_emp_attendance_select"   />  </td>
						  <td><label>Emp Attendance Select</label>   </td>
						  <td>
							 
			                 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="sub_panel_student_rfid_attendance"   />  </td>
						  <td> <label>Student Rfid Attendance</label>  </td>
						  <td>
							 
			                <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="sub_panel_emp_rfid_attendance"   />  </td>
						  <td><label>Emp Rfid Attendance</label>
							
							</td>
							
						 <td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="attendance_sub_panel_registerwise_staff_attendance"   /> 
						 </td> 
						<td>
						...
						<td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="attendance_sub_panel_atendance_graph"   /> 
						 </td> 
						<td>
					     ...
					     <td></td>     
					     <td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="attendance_sub_panel_student_report_daily_classwise"   /> 
						 </td> 
						<td>
						...
						<td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="attendance_sub_panel_student_report_studentwise_monthly"   /> 
						 </td> 
						<td>
					    ...
					    <td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="attendance_sub_panel_emp_report_daily_categorywise"   /> 
						 </td> 
						<td>
					   ...
					   <td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="attendance_sub_panel_emp_report_employeewise"   /> 
						 </td> 
						<td>
						...
						<td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="attendance_sub_panel_student_att_report_daytime"   /> 
						 </td> 
						<td>
						...
						<td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_2"   onclick="check_all_panel_wise_all('2')" value="attendance_sub_panel_emp_att_report_daytime"   /> 
						 </td> 
						<td>
					   ...
					   <input type="checkbox"  name="panel_rights[]" id="panel_3" onclick="check_all_panel_wise('3')"  class="check_all_panel"   value="panel_bus"   />
						...
						<tr>
						  ...
						  <td>
						   ...
						   <input type="checkbox"  name="panel_rights[]" id="panel_4" onclick="check_all_panel_wise('4')"  class="check_all_panel"   value="panel_certificate"   />
						    ...
						    <tr><td>5</td><td>
						   <input type="checkbox"  name="panel_rights[]" id="panel_5" onclick="check_all_panel_wise('5')" checked class="check_all_panel"   value="panel_complaint"   />
			                  </td><td><label>Complaints</label></td>
						  <td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_5"   onclick="check_all_panel_wise_all('5')" value="sub_panel_student_complaint"   />
			                  </td><td><label>Student Complaint</label></td>
			              <td>
						      <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_5"   onclick="check_all_panel_wise_all('5')" value="sub_panel_staff_complaint"   />
			              </td>
			              <td><label>Staff Complaint</label>
			              </td>
			              
			              <td>
						      <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_5"   onclick="check_all_panel_wise_all('5')" value="complaint_sub_panel_employee_complaint"   />
			              </td>
			              <td>
			              ...
			              <td>						  
						   ...
						   <input type="checkbox"  name="panel_rights[]" id="panel_6" onclick="check_all_panel_wise('6')" checked class="check_all_panel"   value="panel_downloads"   />
			                  </td><td rowspan="2"><label>Downloads</label></td>
						  <td>
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="sub_panel_student_admission_list_download_class_wise"   />
			                  </td><td><label>Student Admission List Download Class Wise</label></td><td>
							
							<input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="sub_panel_employee_list_download_category_wise"   />
			                  </td><td><label>Employee List Download Category Wise</label></td><td>
							
							<input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="sub_panel_staff_salary_list_download_month_wise"   />
			                  </td><td><label>Staff Salary List Download Month Wise</label></td><td>
							
							<input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="sub_panel_enquiry_download_date_wise"   />
			                  </td><td><label>Enquiry Download Date Wise</label></td><td>
						 
						  
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="sub_panel_student_fee_list_download_month_wise"   />
			                  </td><td><label>Student Fee List Download Month Wise</label></td><td>
							
						  <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="sub_panel_expense_list_download_month_wise"   />
			                  </td><td><label>Expense List Download Month Wise</label></td>
							</tr>
							<tr>
							<td>
							 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="sub_panel_income_list_download_month_wise"   />
			                  </td><td><label>Income List Download Month Wise</label></td>
			                  
			                  <td>
							 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="download_sub_panel_attendance_list"   />
			                  </td>
			                  <td><label>Download Attendance List</label>
			                  </td>
			                  
			                  <td>
							 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="download_sub_panel_userid_password"   />
			                  </td>
			                  <td><label>Download User id and password</label>
			                  </td>
			                  
			                  <td>
							 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_6"   onclick="check_all_panel_wise_all('6')" value="download_sub_panel_tc_list"   />
			                  </td>
						    ...
						    <tr><td>7</td><td>
						   <input type="checkbox"  name="panel_rights[]" id="panel_7" onclick="check_all_panel_wise('7')" checked class="check_all_panel"   value="panel_dues"   />
			                   </td><td><label>Dues</label></td>
						 <td>
						 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_7"   onclick="check_all_panel_wise_all('7')" value="sub_panel_class_wise_dues_details"   />
						...
						<td>
						 ...
						 <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_11"   onclick="check_all_panel_wise_all('11')" value="sub_panel_admit_card"   />
						   ...
						   <input type="checkbox"  name="panel_rights[]" id="panel_12" onclick="check_all_panel_wise('12')"  class="check_all_panel"   value="panel_fees"   />
			                   </td><td rowspan="2"><label>Fees</label></td>
						 
						 <td rowspan="2">
						        <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_reset_months_or_installment"   />
			             </td>
			             <td rowspan="2">
						 ...
						 <td rowspan="2">
						 <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="sub_panel_fee_structure_list"   />
			                  </td><td rowspan="2"><label>Fee Structure List</label></td><td rowspan="2">
							
							<input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="sub_panel_discount_types_list"   />
			                  </td><td rowspan="2"><label>Discount Types List</label></td><td>
							
							<input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="sub_panel_student_fee_add_form"   />
			                  </td><td><label>Pay Fees</label></td>
			                  
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="sub_panel_student_fee_list"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_set_dues_detail"   />
			            </td>
			            <td>
						 ...
						 <tr>
						  ...
						  <td><input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12');" value="sub_panel_submission_date_change"  />
			                 </td>
						  <td> <label style="color:Green">Submission Date Change</label></td>
						    <td>
							 
							 <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"  onclick="check_all_panel_wise_all('12');" value="sub_panel_fee_list_delete"   />
			                </td>
						 ...
						 <tr>
						     ...
						     <td></td>
						<td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_set_fee"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_set_fees_classwise"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_set_transport_fee_classwise"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_previous_dues"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_print_chalan"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_fees_detail_by_rfid"   />
			            </td>
			            <td>
						...
						<tr>
						 ...
						 <td></td>   
						  <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_dues_list_sms_print"   />
			            </td>
			            <td>
			               <label>Dues List and Sms</label>
			            </td> 
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_demand_bill"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_student_income_tax"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_transport_reset_month"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_transport_set_dues_detail"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_transport_fees_structure"   />
			            </td>
			            <td>
			            ...
			            <td></td>       
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_transport_set_fee_classwise"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_transport_pay_fee"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_transport_fee_details"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_report_panel"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_transport_reports_panel"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_sub_panel_bus_id_card"   />
			            </td>
			            <td>
			            ...
			            <td></td>       
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_panel_delete_button"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_panel_edit_button"   />
			            </td>
			            <td>
			            ...
			            <td>
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_12"   onclick="check_all_panel_wise_all('12')" value="fees_panel_details_button"   />
			            </td>
			            <td>
			            ...
			            <td>
			             ...
			             <td>
						  ...
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_17"   onclick="check_all_panel_wise_all('17')" value="sub_panel_hostel_purchase_list"   />
						   ...
						   <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_17"   onclick="check_all_panel_wise_all('17')" value="sub_panel_account_collection"   />
			                ...
			                <td> 
			               <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_17"   onclick="check_all_panel_wise_all('17')" value="hostal_panel_edit_delete_button"   />
			             ...
			             <tr>
						  ...
						  <td></td>
						  <td>
						 <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_21"   onclick="check_all_panel_wise_all('20')" value="recycle_sub_panel_reset_delete_button"   />
			              </td>
			              <td>
			             ...
			             <td>
						  ...
						  <input type="checkbox"     name="panel_rights[]" class="check_all_panel check_26"   onclick="check_all_panel_wise_all('26')" value="sub_panel_attendance_employee_add"   />
							...
							<input type="checkbox"     name="panel_rights[]" class="check_all_panel check_26"   onclick="check_all_panel_wise_all('26')" value="sub_panel_attendance_employee_list"   />
			                  ...
			                  <td>
							   <input type="checkbox" checked    name="panel_rights[]" class="check_all_panel check_26"   onclick="check_all_panel_wise_all('26')" value="staff_sub_panel_drop_list"   />
			                  </td>
			                  <td>
		...
		<tbody>
				                <tr>
                  <td>1</td>
                  <td> <input type="checkbox"  name="class_right[]" class="check_all_class" id="id_check_all_classwise1" onclick="class_wise_check('1');" checked value="NURSERY"   />   <label>NURSERY</label></td>
				  <input type="hidden" name='section1[]' value="5" />
				  
				  
				  
				  
                  <td>  		 <input type="checkbox"  name="NURSERY_section[] "  class="check_all_class check_all_classwise1" value="A" checked onclick="class_wise_check_reverse('1');" />
				     <label>A</label>
				    ...
				    <input type="checkbox"  name="NURSERY_section[] "  class="check_all_class check_all_classwise1" value="D"  onclick="class_wise_check_reverse('1');" />
				     ...
				     <label>E</label>	
                               ...
                               <tr>
                  <td>2</td>
                  <td> <input type="checkbox"  name="class_right[]" class="check_all_class" id="id_check_all_classwise2" onclick="class_wise_check('2');" checked value="LKG"   />   <label>LKG</label></td>
				  <input type="hidden" name='section1[]' value="2" />
				  
				  
				  
				  
                  <td>  		 <input type="checkbox"  name="LKG_section[] "  class="check_all_class check_all_classwise2" value="A" checked onclick="class_wise_check_reverse('2');" />
				     <label>A</label>
				  ...
				  <input type="checkbox"  name="11TH_section[] " class="check_all_class check_all_classwise14"  value="A"   onclick="class_wise_check_reverse('14');" />
				     <label>A</label>
                               ...
                               <tr>
                  <td>15</td>
                  <td> <input type="checkbox"  name="class_right[]" class="check_all_class" id="id_check_all_classwise15" onclick="class_wise_check('15');" checked value="12TH"   />   <label>12TH</label></td>
				  <input type="hidden" name='section1[]' value="1" />
                  ...
                  <td>   
				  <input type="checkbox"  name="12TH_section[] " class="check_all_class check_all_classwise15"  value="A"  checked onclick="class_wise_check_reverse('15');" />
				     <label>A</label>
