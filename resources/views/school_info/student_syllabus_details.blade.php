...
function for_list() {
    ...
    if (student_class_section != '' && student_class != '' && subject_name != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "school_info/ajax_student_syllabus_details.php?id=" + student_class +
                "&student_section=" + student_class_section + "&subject_name=" + subject_name + "",
            cache: false,
            success: function(detail) {
...
function for_complete(s_no, value) {
    $.ajax({
        type: "POST",
        url: access_link + "school_info/ajax_student_syllabus_details_complete_incomplete.php?s_no=" + s_no +
            "&value=" + value + "",
        cache: false,
        success: function(detail) {
            ...
            <div class="box-body">
                ...
                <div class="col-md-3 ">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="subject_name" id="subject_name" onchange="for_list();"
                            required>
                ...
                <div class="col-md-3 ">
                    <div class="form-group">
                        ...
                        <center><button class="btn btn-success" data-toggle="modal" data-target="#myModal"
                                name=add_more>Add More</button></center>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <center><button type="button" class="btn default"
                                            onclick="exportTableToExcel('example1', 'Syllabus Report')"><i
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody id="example2">
                                    ...
                                    <tr>
                                        ...
                                        <td>03-09-2022</td>
                                        <td>
                                            <button type="button" class="btn btn-primary" onclick="for_edit('15');"
                                                name="edit">Edit</button>&nbsp;
                                            <button type="button" class="btn btn-danger" onclick="return valid('15');"
                                                name="delete">Delete</button>&nbsp;
                                            <button type="button" class="btn btn-default"
                                                onclick="for_complete('15','Incomplete');"
                                                name="complete/incomplete">Complete</button>
                                        </td>
                                    </tr>
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Class<font style="color:red"><b>*</b></font></label>
                                <select name="model_student_class" onchange="for_section1(this.value);"
                                    id="model_student_class" class="form-control" required>
                                    <option value="">Select Class</option>
                                    <option value="NURSERY">NURSERY</option>
                                    <option value="LKG">LKG</option>
                                    <option value="UKG">UKG</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Section<font style="color:red"><b>*</b></font></label>
                                <select class="form-control" name="model_student_class_section"
                                    id="model_student_class_section" onchange="for_subject1();" required>
                                    <option value="">Select Section</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="model_subject_teacher"
                                    id="model_subject_teacher" style="width:100%" required>
                                    ...
                                    <option value="Pankajini Patra">Pankajini Patra[Rajanikanta Mund][8249570835]
                                    </option>
                                    <option value="Jyoti Ranjan Patra">Jyoti Ranjan Patra[Dhirendra Kumar
                                        Patra][+917008251522]</option>
                                    <option value="Premshankar Yadav">Premshankar Yadav[vijay shankar][8249570835]
                                    </option>
                                    ...
                                    <option value="MR. SANTOSH KUMAR SAHU">MR. SANTOSH KUMAR SAHU[TABAL SINGH
                                        ][8718909760]</option>
                                    ...
                                    <option value="MD JAHIR KHAN">MD JAHIR KHAN[MD jalaluddin khan][+919086669999]
                                    </option>
                                    <option value="satyaprakash yadav">satyaprakash yadav[raj pal singh
                                        yadav][9638277283]</option>
                                    ...
                                    <option value="Priyanka kaushik">Priyanka kaushik[Neeprit rajvansh][9926534586]
                                    </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="model_syllabus_estimated_completion_date" value="2022-12-13"
                                    class="form-control" required />
                            </div>
                        </div>
...
<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal1" id="edit_button"
