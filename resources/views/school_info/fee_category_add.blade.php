                     ...
                     <table id="table-data" class="table table-bordered table-striped">
                         ...
                         <tbody>
                             ...
                             <tr align='center'>
                                 ...
                                 <th><button type="button" id="category1" name="Non- RTE|?|new" class="btn btn-success"
                             ...
                             <tr align='center'>
                                 ...
                                 <th><button type="button" id="category2" name="New |?|" class="btn btn-success"
                                         onclick="add_edit(this.id,this.name)" data-toggle="modal"
                                         data-target="#myModal">Add/Edit</th>
                             </tr>
                             ...
                             <tr align='center'>
                                 ...
                                 <th><button type="button" id="category3" name="Oid |?|" class="btn btn-success"
                                         onclick="add_edit(this.id,this.name)" data-toggle="modal"
                                         data-target="#myModal">Add/Edit</th>
                             </tr>
                             ...
                             <tr align='center'>
                                 ...
                                 <th><button type="button" id="category4" name="Science|?|" class="btn btn-success"
                                         onclick="add_edit(this.id,this.name)" data-toggle="modal"
                                         data-target="#myModal">Add/Edit</th>
                             </tr>
                             ...
                             <tr align='center'>
                                 ...
                                 <th><button type="button" id="category5" name="RTE|?|" class="btn btn-success"
                                         onclick="add_edit(this.id,this.name)" data-toggle="modal"
                                         data-target="#myModal">Add/Edit</th>
                             </tr>
                             ...
                             <tr align='center'>
                                 ...
                                 <th><button type="button" id="category6" name="sibling|?|NEW" class="btn btn-success"
                                         onclick="add_edit(this.id,this.name)" data-toggle="modal"
                                         data-target="#myModal">Add/Edit</th>
                             </tr>
                             <tr align='center'>
                                 <th colspan="4"><button type="button" id="category7" name="|?|" class="btn btn-success"
                                         onclick="add_edit(this.id,this.name)" data-toggle="modal"
