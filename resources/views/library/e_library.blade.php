...
#tr_1 {
    ...
    background-image: url(images/bookshelf_empty_tr.png), url(images/bookshelf_empty_tr1.png), url(images/bookshelf_empty_tr2.png);
     !important;
...
function for_book() {
    ...
    $.ajax({
        type: "POST",
        url: access_link + "library/ajax_get_book_name.php?class_name=" + class_name + "&subject_name=" +
            subject_name + "",
        cache: false,
        success: function(detail) {
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/library')}}"><i class="fa fa-book"></i> Library Management</a></li>
                ...
                <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <select name="class" onchange="for_subject(this.value);" id="student_class"
            ...
            <div class="col-sm-12" id="my_pdf" style="margin-top:50px; margin-bottom:-10px;">
                ...
                <div class="col-md-6" style="margin-top:5px;">
                    <table id="example1" class="table table-bordered table-striped" style="display:none">
                        <thead class="">
                            <tr>
                                <th><input type="text" id="book_name1" color="red" readonly
                                        style="border:none;color:blue"></th>
