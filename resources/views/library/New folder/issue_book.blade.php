					 ...
					 <div class="form-group" >
					  <label >Book Title</label>
						<input type="hidden" class="form-control" name="copy_left" value="226">
							<input type="text" class="form-control" name="book_title"  value="Nectar Textbook" placeholder="Enter Name" readonly /> 
						</div>
				</div>
				<input type="hidden" class="form-control" name="book_id_number" id="book_id_number"  value="02554" placeholder="" readonly /> 

			     <div class="col-md-3 ">						 
					 <div class="form-group" >
					  <label >Author Name</label>
					  <input type="text"  name="author_name" placeholder="Add Student Roll No"  value="Main Textbook" class="form-control"  readonly />
					</div>
				  </div>
