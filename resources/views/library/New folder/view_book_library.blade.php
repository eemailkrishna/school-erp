	...
	<div class="modal fade" id="modal-default">
	    ...
	    <div class="modal-body">
				...
				<div class="col-md-12" style="height:200px;overflow:scroll;" >
		        				<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('0');" value="0">Science[154][8TH][RS Agrawala]				<input type="hidden" name="book_id[]" id="book_id_0" value="154">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_0" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_0" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('1');" value="1">maths[8596589658][NURSERY][nutan tripathi]				<input type="hidden" name="book_id[]" id="book_id_1" value="8596589658">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_1" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_1" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('2');" value="2">science[2][1ST][vbn]				<input type="hidden" name="book_id[]" id="book_id_2" value="2">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_2" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_2" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('3');" value="3">EDF[100][1ST][BDC]				<input type="hidden" name="book_id[]" id="book_id_3" value="100">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_3" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_3" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('4');" value="4">Hindi[122344][10TH][VEj]				<input type="hidden" name="book_id[]" id="book_id_4" value="122344">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_4" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_4" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('5');" value="5">hindi[120][NURSERY][bool]				<input type="hidden" name="book_id[]" id="book_id_5" value="120">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_5" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_5" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('6');" value="6">english[2222][11TH][a k]				<input type="hidden" name="book_id[]" id="book_id_6" value="2222">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_6" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_6" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('7');" value="7">English [25][1ST][Ram ]				<input type="hidden" name="book_id[]" id="book_id_7" value="25">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_7" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_7" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('8');" value="8">Computer[000001][1ST][Deepak Gujrati]				<input type="hidden" name="book_id[]" id="book_id_8" value="000001">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_8" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_8" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('9');" value="9">eng[1001SA][NURSERY][sad]				<input type="hidden" name="book_id[]" id="book_id_9" value="1001SA">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_9" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_9" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('10');" value="10">thhnn[hit_1234][10TH][tyhtyh]				<input type="hidden" name="book_id[]" id="book_id_10" value="hit_1234">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_10" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_10" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('11');" value="11">Hindi[#86756][3RD][SD Singh]				<input type="hidden" name="book_id[]" id="book_id_11" value="#86756">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_11" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_11" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('12');" value="12">[test][6TH][dssd]				<input type="hidden" name="book_id[]" id="book_id_12" value="test">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_12" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_12" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('13');" value="13">hindi[111][1ST][shiva]				<input type="hidden" name="book_id[]" id="book_id_13" value="111">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_13" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_13" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('14');" value="14">Vvv[Hhh][1ST][Gggg]				<input type="hidden" name="book_id[]" id="book_id_14" value="Hhh">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_14" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_14" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('15');" value="15">Python syllabus[12345][12TH][Asif]				<input type="hidden" name="book_id[]" id="book_id_15" value="12345">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_15" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_15" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('16');" value="16">ENGLISH GRAMMAR[500][9TH][RC SAHU]				<input type="hidden" name="book_id[]" id="book_id_16" value="500">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_16" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_16" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('17');" value="17">211111111111111[1111111111111112][12TH][21]				<input type="hidden" name="book_id[]" id="book_id_17" value="1111111111111112">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_17" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_17" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('18');" value="18">hindi[11][1ST][mr. simption]				<input type="hidden" name="book_id[]" id="book_id_18" value="11">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_18" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_18" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('19');" value="19">Hindi[70][3RD][70]				<input type="hidden" name="book_id[]" id="book_id_19" value="70">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_19" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_19" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('20');" value="20">PHYSICS[1001][12TH][CT ]				<input type="hidden" name="book_id[]" id="book_id_20" value="1001">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_20" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_20" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('21');" value="21">HINDI[10000][2ND][LOKESH KUMAR]				<input type="hidden" name="book_id[]" id="book_id_21" value="10000">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_21" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_21" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('22');" value="22">kjh[50000][NURSERY][LOKESH KUMAR]				<input type="hidden" name="book_id[]" id="book_id_22" value="50000">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_22" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_22" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('23');" value="23">Job Interview[+6+][3RD][fv hgf hf]				<input type="hidden" name="book_id[]" id="book_id_23" value="+6+">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_23" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_23" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								<div class="col-md-12" >
				<input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('24');" value="24">English, Mathematics, EVS, GK[02554][2ND][Main Textbook]				<input type="hidden" name="book_id[]" id="book_id_24" value="02554">
				<input type="hidden" class="form-control" name="book_title[]" id="book_title_24" value="" placeholder="Enter Name" readonly />
				<input type="hidden" name="book_author_name[]" id="book_author_name_24" placeholder="Author Name" value="" class="form-control" readonly />
				<!-- <input type="hidden" name="" id="" class="form-control" /> -->
				</div>
								</div>
			<div class="col-md-12" >
			<div class="form-group" >
					  ...
					  <option value="">Select student</option>
					        							<option value="2000084">VIDYA SURYAVANSHI[2000084]-[1ST-A]-[RANJIT SURYAVANSHI-]</option>
														<option value="2000085">YOGENDRA KUMAR SAHU[2000085]-[1ST-A]-[BODHRAM SAHU-]</option>
														...
														<option value="2000089">HARSH VAISHNAW[2000089]-[2ND-A]-[RAMESHWAR VAISHNAW-]</option>
														<option value="2000090">HITESH CHAUHAN[2000090]-[2ND-A]-[NARAYAN CHAUHAN-]</option>
														<option value="2000091">KAMINI MAHANT[2000091]-[2ND-A]-[BUDHRAM MAHANT-9340188163]</option>
														<option value="2000092">SANCHAYNI DIWAKAR[2000092]-[2ND-A]-[RAJKUMAR DIWAKAR-]</option>
														<option value="2000093">SALONA DIWAKAR[2000093]-[2ND-A]-[SHIV KUMAR DIWAKAR-]</option>
														<option value="2000094">ANISH CHAUHAN[2000094]-[3RD-A]-[PURUSHOTTAM CHAUHAN-]</option>
														<option value="2000095">BHUMIKA LAHRE [2000095]-[3RD-A]-[HIMANCHAL LAHRE-]</option>
														<option value="2000096">CHANCHAL LAHRE[2000096]-[3RD-A]-[RAJENDRA KUMAR LAHRE-]</option>
														...
														<option value="2000099">DEENBANDHU SAHU[2000099]-[3RD-A]-[SHYAMSHUNDAR SAHU-]</option>
														<option value="2000100">PRIYA PRADHAN[2000100]-[3RD-A]-[BRIJNANDAN PRADHAN-]</option>
														<option value="2000102">PRATAP GARHEWAL[2000102]-[3RD-A]-[BADRI PRASAD GARHEWAL-]</option>
														...
														<option value="2000105">RASHMI VAISHNAW[2000105]-[3RD-A]-[RAMESHWAR VAISHNAW-]</option>
														<option value="2000106">LUCKY SURYAWANSHI[2000106]-[3RD-A]-[NILKAMAL SURYAWANSHI-]</option>
														<option value="2000107">NOHAR PRASAD SAHU[2000107]-[4TH-A]-[MOHIT RAM SAHU-]</option>
														<option value="2000108">OMPRAKASH CHAUHAN[2000108]-[4TH-A]-[RAMKISHAN CHAUHAN-]</option>
														...
														<option value="2000111">LISHA NAGWAKAR[2000111]-[4TH-A]-[SURENDRA SINGH NAGWAKAR-]</option>
														<option value="2000112">HANSIKA LAHARE[2000112]-[4TH-A]-[RAJENDRA KUMAR LAHRE-]</option>
														...
														<option value="2000115">RESHMA PRADHAN[2000115]-[7TH-A]-[HARISHANKAR PRADHAN-]</option>
														<option value="2000116">SAPANA PRADHAN[2000116]-[7TH-A]-[RAMNARAYAN PRADHAN-]</option>
														<option value="2000117">SAMA SONWANI[2000117]-[7TH-A]-[RATHLAL SONWANI-]</option>
														<option value="2000118">TOLESH KUAMAR SAHU[2000118]-[7TH-A]-[GULAB CHAN SAHU-]</option>
														<option value="2000119">NISHA PRADHAN[2000119]-[7TH-A]-[HARISHANKAR PRADHAN-]</option>
														<option value="2000121">umesh [2000121]-[NURSERY-A]-[abhishek-]</option>
														<option value="2000124">Ravi Kumar[2000124]-[1ST-A]-[Anil-]</option>
														<option value="2000125">SURYANSH KUMAR PRAJAPATI[2000125]-[NURSERY-A]-[PANKAJ KUMAR PRAJAPATI-7843999808]</option>
														...
														<option value="2000137">Anurag Singh [2000137]-[1ST-A]-[Mahesh Singh -9198234020]</option>
														<option value="2000138">abhiyank[2000138]-[NURSERY-A]-[suresh-9893492355]</option>
														<option value="2000140">MD JAHIR KHAN[2000140]-[9TH-A]-[MD JALALUDDIN KHAN-7005098908]</option>
														...
														<option value="2000144">Anushka sharma[2000144]-[LKG-A]-[Hari sharma-8210933925]</option>
														<option value="2000145">Sonu[2000145]-[LKG-A]-[Monu-9102428938]</option>
														<option value="2000146">Hariom pandey[2000146]-[NURSERY-A]-[Asbind Kumar pandey-8528073867]</option>
														...
														<option value="2000149">Anushka sharma[2000149]-[UKG-A]-[Hari sharma-8210933925]</option>
														<option value="2000150">Farhan[2000150]-[1ST-A]-[shobh nath-7428222759]</option>
														<option value="2000151">MUZAFFAR HUSSAIN[2000151]-[10TH-A]-[JAMAL DIN-9876345623]</option>
														...
														<option value="2000154">swaroop satish kalinge[2000154]-[3RD-A]-[satish-9341144119]</option>
														...
														<option value="2000161">Tanu yadav[2000161]-[3RD-A]-[Gopal yadav-9826300978]</option>
														...
														<option value="2000165">AMIT JAIN[2000165]-[LKG-A]-[MUKESH JAIN-98930125477477444444144]</option>
														<option value="2000166">prekshya chaudhary[2000166]-[NURSERY-A]-[ravi chaudhary-9412331084]</option>
														<option value="2000167">MUKESH GUPTA[2000167]-[3RD-A]-[ASHOK GUPTA-98930523215]</option>
														<option value="2000168">NAINCY SHARMA[2000168]-[3RD-A]-[Pramod sharma-9893005322]</option>
														...
														<option value="2000175">Praksh shamrav chanore[2000175]-[UKG-A]-[Shamrav chanore-8456231425]</option>
														...
														<option value="2000181">Ashutosh kumar[2000181]-[1ST-A]-[Jhamendra pandey-9801774687]</option>
														<option value="2000182">rahul kumar[2000182]-[NURSERY-A]-[ALKESH PATIDAR-9466438853]</option>
														<option value="2000183">konkon[2000183]-[LKG-A]-[mohan-987989889]</option>
														<option value="2000184">MUKESH GUPTA[2000184]-[3RD-A]-[ASHOK GUPTA-6645654645]</option>
														<option value="2000185">KANIKA RAJAWAT[2000185]-[12TH-A]-[ASHOK GUPTA-16546546546]</option>
														<option value="2000186">Papu Daimary[2000186]-[LKG-A]-[Dhaneswar Daimary-8787681064]</option>
														<option value="2000187">Papu Daimary[2000187]-[LKG-A]-[Dhaneswar Daimary-8787681064]</option>
														...
														<option value="2000201">RAJESH TRIVEDI[2000201]-[NURSERY-A]-[RAMLAL-9800000000]</option>
														<option value="2000202">RUZAINA[2000202]-[LKG-A]-[MOHSIN-9329621221]</option>
														<option value="2000203">radha kumari[2000203]-[NURSERY-A]-[ram mohan singh-7739836507]</option>
														<option value="2000204">RAVINDER SINGH[2000204]-[NURSERY-A]-[BALWANT SINGH-9781294515]</option>
														...
														<option value="2000213">Mr. Dishu Saini[2000213]-[NURSERY-A]-[Mr. Pramod Kumar-8474992612]</option>
														<option value="2000214">Ravinder Singh[2000214]-[5TH-A]-[Balwant Singh-9825298878]</option>
														<option value="2000215">Dyaneshwari[2000215]-[10TH-A]-[Chandrashekhar-9490795976]</option>
														...
														<option value="2000220">PRASHANT DUBEY[2000220]-[12TH-A]-[RAKESH DUBEY-8871712838]</option>
														<option value="2000221">Lawrence Raj[2000221]-[12TH-A]-[Lawrence Raj-9080441063]</option>
														<option value="2000222">ANIL KUMAR[2000222]-[12TH-A]-[MAHESH KUMAR-9425042109]</option>
														<option value="2000223">YASMEEN KHAN[2000223]-[1ST-A]-[SOHAIL KHAN-9997976764]</option>
														<option value="2000224">mahesh[2000224]-[1ST-A]-[rahul-9974366474]</option>
														<option value="2000225">SHAH TEJAS VIPULBHAI[2000225]-[12TH-A]-[VIPULBHAI T SHAH-8401022047]</option>
														<option value="2000226">MOHD AKRAM[2000226]-[6TH-A]-[MOHD RASHID-7036588385]</option>
														...
														<option value="2000229">SHRUTI SINGH[2000229]-[12TH-A]-[DHANANJAY SINGH-8240680593]</option>
														<option value="2000230">vishal vilran[2000230]-[1ST-A]-[Jagdish Chandra-8174902080]</option>
														<option value="2000231">vinod kumar[2000231]-[NURSERY-A]-[bhagirth mak-9785728885]</option>
														...
														<option value="2000236">Sajid Ali[2000236]-[10TH-A]-[Shadhab Ali-9821443746]</option>
														<option value="2000239">nikita [2000239]-[LKG-A]-[sumit-]</option>
														<option value="2000240">raj[2000240]-[NURSERY-A]-[kunal-676765565]</option>
														<option value="2000244">ramesh kumar[2000244]-[LKG-A]-[shobh nath-8853030571]</option>
														<option value="2000247">Safalta Sanodiya [2000247]-[10TH-A]-[Sukhram Sanodiya -6261262501]</option>
														...
														<option value="2000262">Charles Islary[2000262]-[LKG-A]-[Jeffry Islary-9365177191]</option>
														<option value="2000263">Appreciate Muchahary[2000263]-[LKG-A]-[Agwr Gwra Muchahary-7002895981]</option>
														<option value="2000264">Mohan[2000264]-[6TH-A]-[Ram-9582929011]</option>
														<option value="2000267">Adil Zamal[2000267]-[9TH-A]-[Abdul Mannam-4561237890]</option>
														<option value="2000268">rahul kumar[2000268]-[NURSERY-A]-[Shahbudeen kathat-9001807360]</option>
														<option value="2000269">ARMAN KATHAT[2000269]-[1ST-A]-[VIRENDRA KATHAT-9680640640]</option>
														<option value="2000271">sourabh[2000271]-[NURSERY-A]-[gaurav-123456789]</option>
														<option value="2000281">Lakshman singh[2000281]-[12TH-A]-[Jay Singh-7217733825]</option>
														<option value="2000282">Jassu singh[2000282]-[8TH-A]-[Revant singh-9916115014]</option>
														<option value="2000283">Ram Das[2000283]-[7TH-A]-[Sam das-8597474036]</option>
														<option value="2000286">SHAILESH SHARMA[2000286]-[NURSERY-A]-[HARI SHANKER SHARMA-9917473809]</option>
														<option value="2000287">Mohammed Bhoraniya [2000287]-[1ST-A]-[Altaf-9782312334]</option>
														<option value="2000289">Arham Patel[2000289]-[NURSERY-A]-[Abdulnasir-7276231940]</option>
														...
														<option value="2000305">JAGDISH KUMAWAT[2000305]-[12TH-A]-[TOGA RAM-8619478135]</option>
														<option value="2000309">Manan Sharma[2000309]-[9TH-A]-[Harish Sharma-9053660293]</option>
														<option value="2000310">Lavish Sharma[2000310]-[9TH-A]-[Harish Sharma-9315308692]</option>
														...
														<option value="2000321">Amit kumar[2000321]-[10TH-A]-[Shivkumar ram-9140101269]</option>
														...
														<option value="2000332">Palak Kumari[2000332]-[NURSERY-A]-[Krishna Sahani-9876543210]</option>
														<option value="2000337">geeta  kumari[2000337]-[NURSERY-A]-[ram sing-1234567899]</option>
														<option value="2000339">Chetan Tholiya[2000339]-[12TH-A]-[Teja Ram Tholiya-9521465677]</option>
														<option value="2000342">deepak kumar[2000342]-[LKG-A]-[nitish kumar-8229020634]</option>
														<option value="2000345">joy[2000345]-[1ST-A]-[peter-8893387594]</option>
														<option value="2000348">Rashid khan[2000348]-[4TH-A]-[Abdul jabbar-8707413560]</option>
														<option value="2000352">rakesh[2000352]-[NURSERY-A]-[kumar singh-9638527410]</option>
														<option value="2000356">LEYA ANNA ANTONY[2000356]-[2ND-A]-[ANTONY K VARGHESE-7034691897]</option>
														<option value="2000361">KAJAL KUMARI[2000361]-[5TH-A]-[JAGARNATH PRASAD-8757153256]</option>
														<option value="2000369">SuryBhan[2000369]-[12TH-A]-[Ram Prasad Singh-9958252256]</option>
														...
														<option value="2100396">KHANDU DNYANOBA JANBHALE[2100396]-[10TH-A]-[DNYANOBA-875468947684]</option>
														<option value="2100398">AMINA DHABAK[2100398]-[NURSERY-A]-[AJIJUL DHABAK-9851708053]</option>
														<option value="2100399">dummy[2100399]-[NURSERY-A]-[dummy father -1234567890]</option>
														...
														<option value="2100413">Kishan[2100413]-[NURSERY-A]-[Kishan singh-9761332717]</option>
														...
														<option value="2100424">dummy[2100424]-[NURSERY-A]-[dummy father -8219722952]</option>
														...
														<option value="2100431">dummy[2100431]-[NURSERY-A]-[dummy father -9172504377]</option>
														...
														<option value="2100441">Akash kumar[2100441]-[NURSERY-A]-[Horil yadav-875468]</option>
														<option value="2100445">Ram[2100445]-[12TH-A]-[Dashrath ji-8890962585]</option>
														<option value="2100450">umesh  dhakad[2100450]-[NURSERY-A]-[mr  ramgopal dhakad-8269548476]</option>
														...
														<option value="2100458">ayush koli[2100458]-[NURSERY-A]-[prabhu dayal-9826390607]</option>
														<option value="2100463">RAHUL BHAGAT[2100463]-[9TH-A]-[DILIP BHAGAT-8889282268]</option>
														...
														<option value="2100514">વાજા મિત રામસિંગભાઈ[2100514]-[1ST-A]-[રામસિંગભાઈ-8460202427]</option>
														...
														<option value="2200748">pankaj [2200748]-[1ST-A]-[AASHISH JHILLE-7024347776]</option>
														<option value="2200749">Shifa Meman[2200749]-[8TH-A]-[Shabbir Meman-9893840078]</option>
														<option value="2200750">ROHIT KUMAR[2200750]-[1ST-]-[DOODH NATH YADAV-8577908478]</option>
														<option value="2200752">Urvi sen[2200752]-[NURSERY-A]-[Prabhash sen-9101065310]</option>
														<option value="2200753">Akshaj Mishra[2200753]-[2ND-A]-[shesh Narayan Mishra-9685437207]</option>
														<option value="2200756">RAJESH KUMAR MAHTO [2200756]-[5TH-A]-[SITA RAM MAHTO -7488150952]</option>
														...
														<option value="2200759">INAMUR RAHMAN[2200759]-[NURSERY-A]-[ATIKUR RAHMAN-8486304694]</option>
														<option value="2200760">nidhi jain [2200760]-[2ND-A]-[sunil  jain-9988525245]</option>
														...
														<option value="2200763">VINAYAK PATIDAR[2200763]-[4TH-]-[RAHUL MEHRA-456946564]</option>
														<option value="2200764">RANI  KHATRI [2200764]-[12TH-]-[NARAYAN KHATRI -8624542123]</option>
														...
														<option value="2200773">nidhi jain [2200773]-[2ND-A]-[sunil  jain-9668552231]</option>
														...
														<option value="2200776">nidhi jain [2200776]-[2ND-A]-[sunil  jain-9988554665]</option>
														...
														<option value="2200799">TABREZ ALAM[2200799]-[1ST-A]-[BAKRIDAN ANSARI-7677425494]</option>
														...
														<option value="2200803">Kayyum Ansari [2200803]-[UKG-A]-[Shahabuddin Ansari-7571090390]</option>
														<option value="2200804">Chander Mohan[2200804]-[2ND-A]-[Norang Lal-9991199553]</option>
														...
														<option value="2200818">hari shankar kol[2200818]-[12TH-]-[dummy father-121251212]</option>
														...
														<option value="2200825">Sagar Agarwal[2200825]-[NURSERY-B]-[Rajesh Agarwal-9872599661]</option>
														<option value="2200826">Sagar Agarwal[2200826]-[NURSERY-B]-[Rajesh Agarwal-9874563219]</option>
														<option value="2200827">jeet kumar[2200827]-[5TH-A]-[amit kumar -7896454571]</option>
														...
														<option value="2200838">manish[2200838]-[8TH-]-[s.b. shrivastava-9910447389]</option>
														<option value="2200839">harika[2200839]-[NURSERY-A]-[murli-9346151027]</option>
														<option value="2200840">king kholh[2200840]-[LKG-A]-[santosh uikey-123496545]</option>
														...
														<option value="2200848">dsafsdf[2200848]-[NURSERY-A]-[dsfsdfgds-136448654651]</option>
														...
														<option value="2200861">VINAYAK PATIDAR[2200861]-[1ST-A]-[SUNIL RAI-9955882211]</option>
														...
														<option value="2200864">NIDHI SINGH[2200864]-[4TH-]-[RAMRAJ SINGH-89789665677]</option>
														...
														<option value="2200881">aashish xyz [2200881]-[NURSERY-A]-[aaaaaaaaa-5656565656]</option>
														<option value="2200882">rekha [2200882]-[2ND-A]-[mohit-5656586568]</option>
														<option value="2200883">Farhan khan[2200883]-[7TH-A]-[Riyaz khan-458963248327]</option>
														...
														<option value="2200894">nidhi [2200894]-[NURSERY-A]-[ram parkash -7845129632]</option>
														...
														<option value="2200897">rakesh kumar [2200897]-[10TH-A]-[jitendar -9856231487]</option>
														...
														<option value="2200901">neha parihar [2200901]-[LKG-A]-[himanshu parihar -7854126359]</option>
														<option value="2200902">anshu jha [2200902]-[NURSERY-A]-[ravindr jha -9856231478]</option>
														<option value="2200903">aryan singh[2200903]-[NURSERY-A]-[omprakash singh-9854254614]</option>
														...
														<option value="2200911">Aaradhy choubey[2200911]-[1ST-A]-[atul choubey-9993501345]</option>
														...
														<option value="2200923">MANAV RAI[2200923]-[1ST-A]-[RAJENDRA PATIDAR-9955336677]</option>
														...
														<option value="2200927">VINAYAK PATIDAR[2200927]-[1ST-A]-[RAJENDRA PATIDAR-9988552233]</option>
														<option value="2200928">vipin kumar[2200928]-[12TH-A]-[harish chandra-9936563372]</option>
														...
														<option value="2200935">Aayan khan[2200935]-[NURSERY-A]-[Zubair khan-7849533494]</option>
														<option value="2200936">vicky uikey[2200936]-[1ST-A]-[jitendra singh uikey-7354713649]</option>
														<option value="2200937">Chirag jatav[2200937]-[1ST-A]-[MR.Arjun jatav-123]</option>
														<option value="2200938">Pooja bairagi [2200938]-[7TH-A]-[Smt. Meenu bairagi-963486652388]</option>
														<option value="2200939">rajkumar[2200939]-[7TH-A]-[Rammu lal-544564]</option>
														<option value="2200940">Neeraj Agrawal[2200940]-[NURSERY-A]-[Subhash-9300251956]</option>
														...
														<option value="2200943">Md. Mokarram alam [2200943]-[LKG-A]-[Md. Siddique alam -6200665811]</option>
														<option value="2200944">himanshu sidam [2200944]-[11TH-]-[yatish sidam -1234554321]</option>
														...
														<option value="2200954">AMAN BHARTI[2200954]-[8TH-]-[SONU KUMAR BHARTI-9102993075]</option>
														<option value="2200806">mahi[2200806]-[UKG-A]-[ram singh -7024510634]</option>
														<option value="2200955">RAM KUMAR [2200955]-[1ST-]-[SHYAM KUMAR -8936860311]</option>
														...
														<option value="2200960">UMESH KUMAR KUSHWAHA[2200960]-[NURSERY-A]-[KANHAI-4523659874]</option>
														<option value="2200961">NIDHI SINGH[2200961]-[1ST-A]-[BHARAT PATIDAR-824685465]</option>
														...
														<option value="2200962">shravan singh[2200962]-[1ST-A]-[rajaram singh-9452358861]</option>
														...
														<option value="2200970">AAISHA KURREY[2200970]-[10TH-A]-[SANJEEV KUMAR KURREY-2136547899]</option>
														...
														<option value="2200973">ravina singh [2200973]-[10TH-A]-[dev singh -5461237890]</option>
														<option value="2200974">kamalkant[2200974]-[7TH-A]-[vasudev dhakad-9752199047]</option>
														...
														<option value="2200977">Aarunya Raj Sinha[2200977]-[LKG-A]-[tret-87874545454]</option>
														...
														<option value="2200983">shamli mashram [2200983]-[NURSERY-A]-[harichandra -1234567899]</option>
														...
														<option value="2200993">VEDANT TIWARI[2200993]-[7TH-A]-[MANOJ KUMAR TIWARI-8090688671]</option>
														<option value="2201004">pawan[2201004]-[2ND-A]-[mfldfe-64611649611]</option>
														<option value="2201005">hghgkjnlklml[2201005]-[1ST-A]-[-]</option>
														<option value="2201006">SAJIYA FIRDOSH[2201006]-[LKG-A]-[SK HEDAYTULLAH-7504631786]</option>
														...
														<option value="2201013">RISHITA ASHOK KANKUNTLA[2201013]-[1ST-A]-[-36251145222]</option>
														<option value="2201014">Himanshu kushwaha[2201014]-[11TH-A]-[Virendra kushwaha -8004561271]</option>
														<option value="2201015">Prashant [2201015]-[7TH-A]-[rammu lal -7441000]</option>
														<option value="2201010">Prashant [2201010]-[7TH-A]-[rammu lal -74444]</option>
														<option value="2201015">Prashant [2201015]-[7TH-A]-[rammu lal -7441000]</option>
														<option value="2201017">रधिका महेश्वरि [2201017]-[1ST-A]-[प्रकाश महेश्वरि-7779999777]</option>
														...
														<option value="2201021">AYUSH SAHU[2201021]-[LKG-A]-[RAKESH KUMAR-9984908313]</option>
														<option value="2201022">Warda Sahar[2201022]-[10TH-A]-[Mohd Junaid-9839054804]</option>
														<option value="2201023">ANJITA BANJARE[2201023]-[NURSERY-A]-[CHHUNNI LAL BANJARE-7772345028]</option>
														<option value="2201025">PAYAL SAHU[2201025]-[2ND-A]-[VINOD SAHU-7458668265]</option>
														<option value="2201026">Sharan Kumar [2201026]-[12TH-A]-[Nagnath -6363352757]</option>
														...
														<option value="2201028">suhani raj singh ji [2201028]-[5TH-A]-[kkkkkkk-9335206818]</option>
														...
														<option value="2000342">deepak kumar[2000342]-[2ND-A]-[nitish kumar-8229020634]</option>
														...
														<option value="2200791">shreyansh[2200791]-[2ND-A]-[Neeraj kumar-9911587539]</option>
														...
														<option value="2200841">vicky uikey[2200841]-[2ND-A]-[jitendrasingh uikey-7354713649]</option>
														...
														<option value="2100541">Sagar Singh[2100541]-[8TH-A]-[Rakesh Singh-1234567890]</option>
														<option value="2200632">MANVEER SINGH [2200632]-[8TH-A]-[GURDEV SINGH -836009915]</option>
														<option value="2200637">Kiran Sharma[2200637]-[8TH-A]-[Ramu Sharma-123456789]</option>
														...
														<option value="2200641">Heena Mittal[2200641]-[8TH-A]-[Lalu Pasad-567891234]</option>
														...
														<option value="2201060">RAJESH SINGH[2201060]-[1ST-A]-[HARBHAJAN SINGH-9501492060]</option>
														<option value="2201061">ANIL SINGH[2201061]-[12TH-A]-[HARBHAJAN SINGH-9815603856]</option>
														...
														<option value="2201069">Anamika Agrawal[2201069]-[8TH-A]-[Sushil Agrawal-9111111111]</option>
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="box box-success" >
	        ...
	        <th>1</th>
	        <th>02554</th>
	        <th>Nectar Textbook</th>
	        <th>English, Mathematics, EVS, GK</th>
			<th>2ND</th>
			<th>Main Textbook</th>
	        <th></th>
		    <th></th>
		...
		<th>
		<button type="button"  class="btn btn-info" onclick="post_content('library/issue_book','id=02554');" >Issue</button>
		<button type="button" class="btn btn-success" onclick="post_content('library/edit_book','id=02554');" >Edit</button>
		<button type="button" class="btn btn-danger" onclick="return valid('34');" >Delete</button>
		</th>
		...
		<th>
		<button type="button"  class="btn btn-info" onclick="post_content('library/issue_book','id=+6+');" >Issue</button>
		<button type="button" class="btn btn-success" onclick="post_content('library/edit_book','id=+6+');" >Edit</button>
		<button type="button" class="btn btn-danger" onclick="return valid('32');" >Delete</button>
		</th>
		...
		<th>
		<button type="button"  class="btn btn-info" onclick="post_content('library/issue_book','id=test');" >Issue</button>
		<button type="button" class="btn btn-success" onclick="post_content('library/edit_book','id=test');" >Edit</button>
