            ...
            <form method="post" id="my_form">
                <div class="modal-body">
                    ...
                    <div class="col-md-12" style="height:200px;overflow:scroll;">
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('0');"
                                value="0">Science[154][8TH][RS Agrawala] <input type="hidden" name="book_id[]"
                                id="book_id_0" value="154">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_0" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_0"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('1');"
                                value="1">maths[8596589658][NURSERY][nutan tripathi] <input type="hidden"
                                name="book_id[]" id="book_id_1" value="8596589658">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_1" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_1"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('2');"
                                value="2">science[2][1ST][vbn] <input type="hidden" name="book_id[]" id="book_id_2"
                                value="2">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_2" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_2"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('3');"
                                value="3">EDF[100][1ST][BDC] <input type="hidden" name="book_id[]" id="book_id_3"
                                value="100">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_3" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_3"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('4');"
                                value="4">Hindi[122344][10TH][VEj] <input type="hidden" name="book_id[]" id="book_id_4"
                                value="122344">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_4" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_4"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('5');"
                                value="5">hindi[120][NURSERY][bool] <input type="hidden" name="book_id[]" id="book_id_5"
                                value="120">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_5" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_5"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('6');"
                                value="6">english[2222][11TH][a k] <input type="hidden" name="book_id[]" id="book_id_6"
                                value="2222">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_6" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_6"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('7');"
                                value="7">English [25][1ST][Ram ] <input type="hidden" name="book_id[]" id="book_id_7"
                                value="25">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_7" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_7"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('8');"
                                value="8">Computer[000001][1ST][Deepak Gujrati] <input type="hidden" name="book_id[]"
                                id="book_id_8" value="000001">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_8" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_8"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('9');"
                                value="9">eng[1001SA][NURSERY][sad] <input type="hidden" name="book_id[]" id="book_id_9"
                                value="1001SA">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_9" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_9"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('10');"
                                value="10">thhnn[hit_1234][10TH][tyhtyh] <input type="hidden" name="book_id[]"
                                id="book_id_10" value="hit_1234">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_10" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_10"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('11');"
                                value="11">Hindi[#86756][3RD][SD Singh] <input type="hidden" name="book_id[]"
                                id="book_id_11" value="#86756">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_11" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_11"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('12');"
                                value="12">[test][6TH][dssd] <input type="hidden" name="book_id[]" id="book_id_12"
                                value="test">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_12" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_12"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('13');"
                                value="13">hindi[111][1ST][shiva] <input type="hidden" name="book_id[]" id="book_id_13"
                                value="111">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_13" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_13"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('14');"
                                value="14">Vvv[Hhh][1ST][Gggg] <input type="hidden" name="book_id[]" id="book_id_14"
                                value="Hhh">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_14" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_14"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('15');"
                                value="15">Python syllabus[12345][12TH][Asif] <input type="hidden" name="book_id[]"
                                id="book_id_15" value="12345">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_15" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_15"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('16');"
                                value="16">ENGLISH GRAMMAR[500][9TH][RC SAHU] <input type="hidden" name="book_id[]"
                                id="book_id_16" value="500">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_16" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_16"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('17');"
                                value="17">211111111111111[1111111111111112][12TH][21] <input type="hidden"
                                name="book_id[]" id="book_id_17" value="1111111111111112">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_17" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_17"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('18');"
                                value="18">hindi[11][1ST][mr. simption] <input type="hidden" name="book_id[]"
                                id="book_id_18" value="11">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_18" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_18"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('19');"
                                value="19">Hindi[70][3RD][70] <input type="hidden" name="book_id[]" id="book_id_19"
                                value="70">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_19" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_19"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('20');"
                                value="20">PHYSICS[1001][12TH][CT ] <input type="hidden" name="book_id[]"
                                id="book_id_20" value="1001">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_20" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_20"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('21');"
                                value="21">HINDI[10000][2ND][LOKESH KUMAR] <input type="hidden" name="book_id[]"
                                id="book_id_21" value="10000">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_21" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_21"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('22');"
                                value="22">kjh[50000][NURSERY][LOKESH KUMAR] <input type="hidden" name="book_id[]"
                                id="book_id_22" value="50000">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_22" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_22"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('23');"
                                value="23">Job Interview[+6+][3RD][fv hgf hf] <input type="hidden" name="book_id[]"
                                id="book_id_23" value="+6+">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_23" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_23"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                        <div class="col-md-12">
                            <input type="checkbox" name="issue_book_ser[]" onclick="fill_bookdetail('24');"
                                value="24">English, Mathematics, EVS, GK[02554][2ND][Main Textbook] <input type="hidden"
                                name="book_id[]" id="book_id_24" value="02554">
                            <input type="hidden" class="form-control" name="book_title[]" id="book_title_24" value=""
                                placeholder="Enter Name" readonly />
                            <input type="hidden" name="book_author_name[]" id="book_author_name_24"
                                placeholder="Author Name" value="" class="form-control" readonly />
                            <!-- <input type="hidden" name="" id="" class="form-control" /> -->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Borrower's Name<font size="2" style="font-weight: normal;">
                                    (Search by Name,Unique Id,Class,Section,Father Name,Father Contact Number) </font>
                                <span style="color:red;">*</span></label>
                            <select name="" class="select2" onchange="search_student_details();" id="student_details"
                                ...
                                <option value="2000140">MD JAHIR KHAN[2000140]-[9TH-A]-[MD JALALUDDIN KHAN-7005098908]
                                </option>
                                ...
                                <option value="2000165">AMIT JAIN[2000165]-[LKG-A]-[MUKESH JAIN-98930125477477444444144]
                                </option>
                                ...
                                <option value="2000181">Ashutosh kumar[2000181]-[1ST-A]-[Jhamendra pandey-9801774687]
                                </option>
                                ...
                                <option value="2000203">radha kumari[2000203]-[NURSERY-A]-[ram mohan singh-7739836507]
                                </option>
                                <option value="2000204">RAVINDER SINGH[2000204]-[NURSERY-A]-[BALWANT SINGH-9781294515]
                                </option>
                                ...
                                <option value="2000268">rahul kumar[2000268]-[NURSERY-A]-[Shahbudeen kathat-9001807360]
                                </option>
                                ...
                                <option value="2000332">Palak Kumari[2000332]-[NURSERY-A]-[Krishna Sahani-9876543210]
                                </option>
                                <option value="2000337">geeta kumari[2000337]-[NURSERY-A]-[ram sing-1234567899]</option>
                                <option value="2000339">Chetan Tholiya[2000339]-[12TH-A]-[Teja Ram Tholiya-9521465677]
                                </option>
                                ...
                                <option value="2000356">LEYA ANNA ANTONY[2000356]-[2ND-A]-[ANTONY K VARGHESE-7034691897]
                                </option>
                                ...
                                <option value="2200654">MAHEK DASHORE[2200654]-[11TH-A]-[NAVIN KUMAR DASHORE-9584669888]
                                </option>
                                ...
                                <option value="2100450">umesh dhakad[2100450]-[UKG-A]-[mr ramgopal dhakad-8269548476]
                                </option>
                                ...
                                <option value="2100585">Muhammed Adnan[2100585]-[4TH-A]-[Muhammed Afnan-686868606868]
                                </option>
                                ...
                                <option value="2200753">Akshaj Mishra[2200753]-[2ND-A]-[shesh Narayan Mishra-9685437207]
                                </option>
                                ...
                                <option value="2200759">INAMUR RAHMAN[2200759]-[NURSERY-A]-[ATIKUR RAHMAN-8486304694]
                                </option>
                                ...
                                <option value="2200753">Akshaj Mishra[2200753]-[3RD-A]-[shesh Narayan Mishra-9685437207]
                                </option>
                                ...
                                <option value="2200785">ABHIMANYU SHARMA[2200785]-[NURSERY-A]-[GOURAV SHARMA-9755404505]
                                </option>
                                ...
                                <option value="2200796">SONU PRAJAPATI[2200796]-[2ND-A]-[LALARAM PRAJAPATI-7067208375]
                                </option>
                                <option value="2200798">dummy [2200798]-[2ND-A]-[dummy-1234567890]</option>
                                <option value="2200803">Kayyum Ansari [2200803]-[UKG-A]-[Shahabuddin Ansari-7571090390]
                                </option>
                                ...
                                <option value="2200825">Sagar Agarwal[2200825]-[NURSERY-B]-[Rajesh Agarwal-9872599661]
                                </option>
                                <option value="2200826">Sagar Agarwal[2200826]-[NURSERY-B]-[Rajesh Agarwal-9874563219]
                                </option>
                                ...
                                <option value="2200811">yasin[2200811]-[1ST-A]-[-9931326638]</option>
                                <option value="2200812">sultana[2200812]-[1ST-A]-[-9693212542]</option>
                                <option value="2200841">vicky uikey[2200841]-[1ST-A]-[jitendrasingh uikey-7354713649]
                                </option>
                                ...
                                <option value="2200901">neha parihar [2200901]-[LKG-A]-[himanshu parihar -7854126359]
                                </option>
                                <option value="2200902">anshu jha [2200902]-[NURSERY-A]-[ravindr jha -9856231478]
                                </option>
                                <option value="2200903">aryan singh[2200903]-[NURSERY-A]-[omprakash singh-9854254614]
                                </option>
                                ...
                                <option value="2200927">VINAYAK PATIDAR[2200927]-[1ST-A]-[RAJENDRA PATIDAR-9988552233]
                                </option>
                                ...
                                <option value="2200936">vicky uikey[2200936]-[1ST-A]-[jitendra singh uikey-7354713649]
                                </option>
                                ...
                                <option value="2200960">UMESH KUMAR KUSHWAHA[2200960]-[NURSERY-A]-[KANHAI-4523659874]
                                </option>
                                ...
                                <option value="2200983">shamli mashram [2200983]-[NURSERY-A]-[harichandra -1234567899]
                                </option>
                                <option value="2200901">neha parihar [2200901]-[UKG-A]-[himanshu parihar -7854126359]
                                </option>
                                ...
                                <option value="2200927">VINAYAK PATIDAR[2200927]-[2ND-A]-[RAJENDRA PATIDAR-9988552233]
                                </option>
                                <option value="2200936">vicky uikey[2200936]-[2ND-A]-[jitendra singh uikey-7354713649]
                                </option>
                                ...
                                <option value="2200993">VEDANT TIWARI[2200993]-[7TH-A]-[MANOJ KUMAR TIWARI-8090688671]
                                </option>
                                ...
                                <option value="2200993">VEDANT TIWARI[2200993]-[8TH-A]-[MANOJ KUMAR TIWARI-8090688671]
                                </option>
                                ...
                                <option value="2201010">Prashant [2201010]-[7TH-A]-[rammu lal -74444]</option>
                                <option value="2201015">Prashant [2201015]-[7TH-A]-[rammu lal -7441000]</option>
                                <option value="2201017">रधिका महेश्वरि [2201017]-[1ST-A]-[प्रकाश महेश्वरि-7779999777]
                                </option>
                                ...
                                <option value="2201035">Nitya Yadav[2201035]-[NURSERY-A]-[Mr. Mayank Yadav-8707260755]
                                </option>
                                ...
                                <option value="2201039">Prithviraj[2201039]-[NURSERY-A]-[Dr. Pramod Kumar-9219270152]
                                </option>
                                ...
                                <option value="2200841">vicky uikey[2200841]-[2ND-A]-[jitendrasingh uikey-7354713649]
                                </option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_class_and_section" placeholder="Student Class and section"
                                id="student_class_and_section" class="form-control" readonly />
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" id="myModal_close"
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            <center>
                                <h3 class="box-title" style="color:#592712;font-size:25px;"><b>View Books Details</b>
                                </h3>
                            </center></br>
                        </div>
                        <div class="col-sm-2">
                            <button type="button" name="finish" class="btn btn-primary" value="" data-toggle="modal"
                                data-target="#modal-default">Issue Book</button>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    <button type="button" class="btn btn-info"
                                        onclick="post_content('library/issue_book','id=02554');">Issue</button>
                                    <button type="button" class="btn btn-success"
                                        onclick="post_content('library/edit_book','id=02554');">Edit</button>
                                    <button type="button" class="btn btn-danger"
                                        onclick="return valid('34');">Delete</button>
                                </th>
                            ...
                            <tr>
                                ...
                                <th>
                                    <button type="button" class="btn btn-info"
                                        onclick="post_content('library/issue_book','id=+6+');">Issue</button>
                                    <button type="button" class="btn btn-success"
                                        onclick="post_content('library/edit_book','id=+6+');">Edit</button>
                                    <button type="button" class="btn btn-danger"
                                        onclick="return valid('32');">Delete</button>
                                </th>
                            ...
                            <tr>
                                ...
                                <th>
                                    <button type="button" class="btn btn-info"
                                        onclick="post_content('library/issue_book','id=test');">Issue</button>
                                    <button type="button" class="btn btn-success"
                                        onclick="post_content('library/edit_book','id=test');">Edit</button>
                                    <button type="button" class="btn btn-danger"
                                        onclick="return valid('18');">Delete</button>
                                </th>
