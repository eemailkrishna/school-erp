...
$.ajax({
type: "POST",
url: access_link+"time_table/ajax_get_period.php?class="+class_name+"&section="+class_section+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"",
cache: false,
success: function(detail){
    // console.log(detail)
...
window.scrollTo(0, 0);
    loader();
        $.ajax({
            url: access_link+"time_table/time_table_generate_api.php",
            type: "POST",
            data: formdata,
			...
			<div class="col-md-3">	
			  <div class="form-group">
                ...
                <tr>
                 ...
                 <th style="width:200px"><center>Subject Name</center></th>
                 <th style="width:200px"><center>Teacher Name</center></th>
				 <th style="width:200px"><center>Subject Name</center></th>
                 <th style="width:200px"><center>Teacher Name</center></th>
				 <th style="width:200px"><center>Subject Name</center></th>
                 <th style="width:200px"><center>Teacher Name</center></th>
