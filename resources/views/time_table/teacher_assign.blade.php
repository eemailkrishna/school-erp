...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-body ">
                <h3 class="box-title">Please check that you have already marked staff's attendence and have already
                    filled subject wise teacher list</h3>
    ...
    MySQL server version for the right syntax to use near '112' at line 1
</section>
