            ...
            <a href="{{url('time_table/subject_wise_teacher')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#E326F6;">
                        ...
                        <a href="{{url('time_table/subject_wise_teacher')}}" class="small-box-footer">More Info <i
            ...
            <a href="{{url('time_table/teacher_availability')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#3B7A57;">
                        ...
                        <a href="{{url('time_table/teacher_availability')}}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{url('time_table/diff_add_class_period')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#33E6E6;">
                        ...
                        <a href="{{url('time_table/diff_add_class_period')}}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{url('time_table/diff_time_table_generate')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#E32636;">
                        ...
                        <a href="{{url('time_table/diff_time_table_generate')}}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{url('time_table/diff_time_table_list')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#9F2B68;">
                        ...
                        <a href="{{url('time_table/diff_time_table_list')}}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
