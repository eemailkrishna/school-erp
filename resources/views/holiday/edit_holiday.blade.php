...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/holiday')}}"><i class="fa fa-photo"></i> Holiday</a></li>
        <li><a href="{{url('/holiday_list')}}"><i class="fa fa-list"></i>Holiday List</a></li>
                ...
                <form role="form" method="post" id="my_form">
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="holiday_name" placeholder="Enter Holiday Name" value="HOLI "
                                class="form-control ">
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            <label>Date</label>
                            <input type="date" name="date" placeholder="Enter Date" value="2022-11-29"
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="holiday_description" placeholder="Description of holiday"
                                value="HAPPY HOLI " class="form-control">
                        </div>
                    </div>
