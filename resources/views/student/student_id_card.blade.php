...
function for_list() {
    ...
    $.ajax({
        type: "POST",
        url: access_link + "student/ajax_student_id_card.php?id=" + student_class + "&student_section=" +
            student_class_section + "&student_identity_category=" + student_identity_category + "",
        cache: false,
        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-body">
                <form role="form" method="post" id="my_form"
                    action="../school_software_v1_old/pdf/pdf/id_card_page/id_card_pdf_2.php"
                    onsubmit="return checked_null_value();" enctype="multipart/form-data" target="_blank">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_identity_category" onchange='for_list();'
                                id="student_identity_category">
                                <option value="all">All</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox custom-control-inline ">
                                <input type="checkbox" class="custom-control-input" id="defaultInline1" name="address"
                                    checked value="address" />
                                <label class="custom-control-label" for="defaultInline1">Address</label>
                                <input type="checkbox" class="custom-control-input" id="defaultInline2" name="website"
