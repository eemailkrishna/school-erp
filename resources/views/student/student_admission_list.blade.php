                    ...
                    var dataTable = $('#example1').DataTable({
                        ...
                        "ajax": {
                            url: access_link + "student/student_admission_list_fatch.php?gender=" + gender +
                                ...
                                student_class_stream + "&religion=" + religion + "&caste=" + caste + "&age=" +
                                age + "&scheme=" + scheme + "&type=" + type + "&student_class=" +
                                student_class + "&student_class_section=" + student_class_section +
                                "&bus_fee_category_name=" + bus_fee_category_name + "&sort_by=" + sort_by + "",
                            type: "post"
                        }
                    });
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <div class="form-control">
                                ...
                                <input type="radio" name="student_religion" onclick="for_list();" id="r7"
                                    value="Jain">&nbsp;<b>Jain</b>
                                <input type="radio" name="student_religion" onclick="for_list();" id="r8"
                                    value="Buddh">&nbsp;<b>Buddh</b>
