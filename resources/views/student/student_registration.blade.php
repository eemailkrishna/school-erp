                ...
                <div class="box-body">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_registration_number" value="7284" class="form-control"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="col-md-3" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="text" name="school_name123" id="school_name123" value="SIMPTION TECH PVT LTD"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_name" id="student_name" required placeholder="student Name"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" minlength="10" maxlength="10" name="student_father_contact_number2"
                                placeholder="Father Contact No2." value="" id="student_father_contact_number2"
                                class="form-control new_student">
                        </div>
                    </div>
                    <div class="col-md-3 ">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="student_date_of_birth_in_word1" name="student_date_of_birth_in_word"
                                value="" class="form-control" placeholder="DoB In Word" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3" style="">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_registration_fee" placeholder="Registration Fees" value=""
                                class="form-control">
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="file" name="father_photo" id="father_photo" placeholder=""
                                    onchange="check_file_type(this,'father_photo','show_father_photo','image');"
                                    class="form-control" accept=".gif, .jpg, .jpeg, .png" value="">
                            </div>
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="file" name="mother_photo" id="mother_photo" placeholder=""
                                    onchange="check_file_type(this,'mother_photo','show_mother_photo','image');"
                                    class="form-control" accept=".gif, .jpg, .jpeg, .png" value="">
                            </div>
                        </div>
                        <div class="col-md-1">
