            ...
            <a href="{{url('student/student_registration_list_fatch')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#3B7A57;">
                        ...
                        <a href="{{url('student/student_registration_list_fatch')}}" class="small-box-footer">More Info
            ...
            <a href="{{url('student/student_sms_notification_update')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#585858;">
                        ...
                        <a href="{{url('student/student_sms_notification_update')}}" class="small-box-footer">More Info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{url('student/report_student_strength_castewise')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#ffd700;">
                        ...
                        <a href="{{url('student/report_student_strength_castewise')}}" class="small-box-footer">More
            ...
            <a href="{{url('student/report_student_strength_religionwise')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#4617a0;">
                        ...
                        <a href="{{url('student/report_student_strength_religionwise')}}" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{url('student/student_registration_report')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#898281;">
                        ...
                        <a href="{{url('student/student_registration_report')}}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
