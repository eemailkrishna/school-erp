...
function student_attendance_function() {
    ...
    var content1 = 'id=' + student_roll_no + '&class=' + student_class + '&section=' + section + '&current_month=' +
        current_month + '&year=' + year + '&name=' + name;
...
function student_marksheet_function() {
    ...
    window.open(pdf_path + "marksheet_page/" + marksheet_final_pdf + "?roll_no=" + student_roll_no + "&class=" +
        student_class + "&student_class_group=" + student_class_group + "&student_class_stream=" +
        student_class_stream + "&session1=" + session_value, '_blank');
}
...
function student_examwise_marksheet_function() {
    ...
    window.open(pdf_path + "marksheet_page/" + marksheet_exam_wise_pdf + "?roll_no=" + student_roll_no + "&class=" +
        student_class + "&exam_type=" + exam_type, '_blank');
}
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="student_roll_no" placeholder="Student Roll No"
                                id="student_roll_no" class="form-control" readonly>
                            <input type="text" placeholder="Student Roll No" id="school_roll_no" class="form-control"
                                readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <button type="button" onclick="pay_fee('fees_monthly');" id="pay_fee1"
                                class="btn btn-success form-control" disabled>Pay Fee</button>
                        </div>
                        <div class="col-md-2">
                            <button type="button" id="fee_detail" onclick="fee_detail1('fees_monthly');"
                                class="btn btn-success form-control" title="select student" disabled>Fee
                                Details</button>
                        </div>
                        <div class="col-md-2" style="">
                            <button type="button" onclick="tc_generate1();" id="tc_generate"
                                class="btn btn-success form-control" title="select student" disabled>TC
                                Generate</button>
                        </div>
                        <div class="col-md-2">
                            <button type="button" onclick="pay_penalty()" name="Penalty" id="penalty"
                                class="btn btn-success form-control" title="select student" disabled>Penalty</button>
                        </div>
                        <div class="col-md-3">
                            <button type="button" onclick="student_edit_function()" id="student_edit1"
                                class="btn btn-success form-control" title="select student" disabled>Student
                                Edit</button>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <button type="button" id="assign_rfid" class="btn btn-success form-control"
                                data-toggle="modal" data-target="#modal-default" title="select student" disabled>
                                Assign RFID Card</button>
                        </div>

                        <div class="col-md-3">
                            <button type="button" onclick="student_attendance_function();" id="attendance"
                                class="btn btn-success form-control" title="select student" disabled>Attendance</button>
                        </div>
                        <div class="col-md-3" style="">
                            <button type="submit" onclick="student_marksheet_function();" id="marksheet"
                                class="btn btn-success form-control" title="select student" disabled>Full
                                MarkSheet</button>
                        </div>


                        <div class="col-md-2" style="display:none">
                            <button type="button" onclick="for_exam();" id="exam_wise_marksheet"
                                class="btn btn-success form-control" data-toggle="modal" data-target="#modal-default1"
                                title="select student" disabled>
                                Exam Wise Marksheet</button>
                        </div>
                        <div class="col-md-3">
                            <button type="button" onclick="student_id_card_function();" id="id_card_generate"
                                class="btn btn-success form-control" title="select student" disabled>
                                Id Card Generate</button>
                        </div>

                        <div class="col-md-3">
                            <button type="button" onclick="student_list();" id="student_detail"
                                class="btn btn-success form-control" title="select student" disabled>
            ...
            <div class="modal-content">
                <div class="modal-header my_background_color">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <center>
                        <h4 class="modal-title"><b>Choose Exam Type</b></h4>
                    </center>
                </div>
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" name="student_class_stream11"
                        id="student_class_stream11" />
                    <input type="hidden" class="form-control" name="session_value11" id="session_value11"
                        value="2022_23" />
                ...
                <div class="modal-footer ">
                    <button type="button" class="btn btn-danger pull-left" data-dismiss="modal">Close</button>
                    <input type="button" onclick="student_examwise_marksheet_function();" value="Submit"
