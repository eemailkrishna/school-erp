...
function for_list() {
    ...
    $.ajax({
        type: "POST",
        url: access_link + "student/ajax_student_roll_no.php?id=" + student_class + "&student_section=" +
            student_class_section + "&roll_no_generate_by=" + roll_no_generate_by + "&start_number=" +
            start_number + "&student_class_stream=" + student_class_stream + "&student_admission_type=" +
            student_admission_type + "&order_by=" + order_by + "",
        cache: false,
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_class_stream" onchange='for_list();'
                                id="student_class_stream" style="width:100%;" onchange="for_search11();">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="roll_no_generate_by" onchange='for_list();'
                                id="roll_no_generate_by">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_admission_type" onchange='for_list();'
                                id="student_admission_type">
                                <option value="All">All</option>
