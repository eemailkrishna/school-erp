            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <center><button type="button" class="btn default"
                            onclick="exportTableToExcel('printTable', 'Religion Wise Student Data')"><i
            ...
            <div <div class="box box-success">>
                ...
                <div class="box-body table-responsive" id="printTable">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <span style="font-size:20px;font-weight:bold">
                                <center>STUDENT STRENGTH INFO Religion Wise</center>
                            </span>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="col-md-12">
            <div class="col-md-6">
                <center><button type="button" class="btn btn-success"
                        onclick="exportTableToExcel('printTable', 'Religion Wise Student Data')"><i class="fa fa-print"
