...
function for_list() {
    ...
    if (student_class != '' && student_class_section != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "student/ajax_rfid_get.php?id=" + student_class + "&student_section=" +
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group" style="display:none">
                                            <label>Roll.No.</label>
                                            <input type="hidden" class="form-control" name="student_roll_no"
                                                id="student_roll_no1" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Add RFID</label>
                                            <input type="text" name="student_rf_id_number" id="student_rf_id_number"
