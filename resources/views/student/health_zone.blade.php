...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Medical Fitness</li>
    </ol>
</section>
            ...
            <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                <div class="box-body ">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6 ">
                            <div class="form-group">
                                ...
                                <select name="" class="form-control select2" id="student_select"
                                    onchange="fill_detail();" required>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_class_section" value="" placeholder="Student Section"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_father_name" id="tc_student_father_name"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_cwsn" value="" placeholder="Student CWSN" id="student_cwsn"
                                class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_cwsn_description" value=""
                                placeholder="Student CWSN Description" id="student_cwsn_description"
                                class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="student_medical_history" id="student_medical_history1" class="form-control"
                                onchange="detail1(this.value);" required>
                    ...
                    <div class="col-md-3" style="display:none;" id="for_yes">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_major_illness" value="" placeholder="Major Illness"
                                id="student_major_illness" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_height" value="" placeholder="Student Height"
                                id="student_height" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_weight" value="" placeholder="Student weight"
                                id="student_weight" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <select name="health_checkup" id="checkup_id" class="form-control "
                                    onchange="fill_checkup();" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="checkup_date" value="" placeholder="" id="checkup_date"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="checkup_hospital_name" value="" placeholder="Hospital Name"
                                id="checkup_hospital_name" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="checkup_doctor_name" value="" placeholder="Doctor Name"
                                id="checkup_doctor_name" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Checkup Report</label>
                            <input type="file" name="checkup_report1" id="checkup_report1" placeholder=""
                                onchange="check_file_type(this,'checkup_report1','show_checkup_report1','image');"
                                class="form-control" accept=" .jpg, .jpeg, .png" value="">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                            <img id="show_checkup_report1"
                                src='../school_software_v1_old/images/hostel_student_list.png' width='60px'
                                height='60px'>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" name="blood_group" value="" placeholder="blood_group" id="blood_group"
                            class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="number" name="checkup_bp" value="" placeholder="Blood Pressure Level"
                            id="checkup_bp" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="number" name="checkup_hb" value="" placeholder="Hemoglobin Level" id="checkup_hb"
                            class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="number" name="checkup_suger" value="" placeholder="Diabetes Level"
                            id="checkup_suger" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Specs</label>
                        <select name="specs" class="form-control " id="checkup_specs" onchange="drop(this.value);"
                            required>
                            <option value="No">No</option>
                            <option value="Yes">Yes</option>
                        </select>
                ...
                <div class="col-md-2 " style="display:none;" id="for_eye_left">
                    <div class="form-group">
                        ...
                        <input type="number" name="left_specs_no" value="" placeholder="Left Side No."
                            id="checkup_left_specs_no" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-2 " style="display:none;" id="for_eye_right">
                    <div class="form-group">
                        ...
                        <input type="number" name="right_specs_no" value="" placeholder="Right Side No."
                            id="checkup_right_specs_no" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        <label>Remark</label>
                        <input type="text" name="checkup_remark" value="" placeholder="Remark" id="checkup_remark"
                            class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" name="checkup_discription" value="" placeholder="Descrption"
                            id="checkup_discription" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" name="checkup_marks" value="" placeholder="Health Marks" id="checkup_marks"
                            class="form-control">
                    </div>
                </div>
