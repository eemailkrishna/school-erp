 ...
 newWin.close();
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('student/students')"><i class="fa fa-money"></i> student Panel</a></li>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <div class="col-md-4"><h3 class="box-title">Registration Report download</h3></div>
              <div class="col-md-8">
                &nbsp;
              </div>
            </div>
