...
function for_search11() {
    ...
    if (student_class != '' || student_class_section != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "student/ajax_student_mapping_data_update.php?student_class=" + student_class +
                "&student_class_section=" + student_class_section + "&student_limit=" + student_limit + "",
            success: function(detail) {
