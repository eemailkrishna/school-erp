...
function for_search11() {
    ...
    if (student_class != '' || student_class_section != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "student/ajax_student_profile_update.php?student_class=" + student_class +
                "&student_class_section=" + student_class_section + "&student_class_stream=" +
                student_class_stream + "&student_fee_category_code=" + student_fee_category_code +
...
function for_no(ser_no) {
    ...
    if (student_bus_route != '' && bus_fee_category_name != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "student/ajax_get_student_bus_no_list.php?stop_name=" + category_name[0] +
                "&student_bus_route=" + student_bus_route + "",
            success: function(detail) {
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name=""
                                                        id="student_class_stream" style="width:100%;"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="student_fee_category_code"
                                                        id="student_fee_category_code" onchange="for_search11();">
                                                        <option value="All">All</option>
                                                        </option>
