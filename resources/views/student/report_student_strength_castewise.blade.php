    ...
    <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <center><button type="button" class="btn default"
                            onclick="exportTableToExcel('printTable', 'Caste Wise Student Data')"><i class="fa fa-print"
        ...
        <div class="col-md-12">
            <div style="float: right;">
                <label><input type="checkbox" onclick="check_function();" name="all_medium" id="all_medium"
                        value="" />Plz check for Both Medium</label>
            </div>
        </div>
        <div class="col-md-12">
            ...
            <div <div class="box box-success">>
                ...
                <div class="box-body table-responsive" id="printTable">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <span style="font-size:20px;font-weight:bold">
                                <center>Caste Wise STUDENT STRENGTH INFO</center>
                            </span>
                        </div>
                        <div class="col-md-3">
