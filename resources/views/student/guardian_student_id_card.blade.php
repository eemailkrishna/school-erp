...
function for_list() {
    ...
    $.ajax({
        type: "POST",
        url: access_link + "student/ajax_guardian_student_id_card.php?id=" + student_class +
        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-body ">
                <form role="form" method="post" id="my_form"
                    action="../school_software_v1_old/pdf/pdf/guardian_id_card_page/guardian_id_card.php"
