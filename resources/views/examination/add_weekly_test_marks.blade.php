...
function for_test() {
    ...
    $.ajax({
        address: "POST",
        url: access_link + "examination/ajax_get_weekly_test.php?student_class=" + student_class +
...
function for_student() {
    ...
    if (student_class != '' && test_name != '') {
        $.ajax({
            address: "POST",
            url: access_link + "examination/ajax_weekly_test_student_list.php?student_class=" + student_class +
                "&student_class_section=" + student_class_section + "&student_class_stream=" +
                student_class_stream + "&student_class_group=" + student_class_group + "&test_name=" +
                test_name + "&student_limit=" + student_limit + "",
            cache: false,
            success: function(detail) {
            ...
            <div class="box-body ">
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-2" id="student_class_group_div" style="display:none;">
                        <div class="form-group">
                            <label>Group</label>
                            <select name="student_class_group" id="student_class_group" onchange="for_test();"
                                class="form-control">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>Section</label>
                            <select name="student_class_section" id="student_class_section" onchange="for_test();"
                                class="form-control">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="test_name" id="test_name" onchange="for_student();" class="form-control"
                                required>
                                <option value="">Select</option>
