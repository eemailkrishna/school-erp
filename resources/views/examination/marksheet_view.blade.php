...
function for_list() {
    ...
    if (student_class_section != '' && student_class != '' && exam_type != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "examination/ajax_view_marksheet.php?id=" + student_class + "&student_section=" +
                student_class_section + "&student_exam_type=" + exam_type + "&student_class_stream=" +
...
function print_all(value) {
    ...
    if (student_class_section != '' && student_class != '' && exam_type != '') {
        ...
        if (value == 1) {
            var url2 = pdf_path + "marksheet_page/" + marksheet_exam_wise_all_pdf + "?class=" + student_class +
                "&section=" + student_class_section + "&exam_type=" + exam_type + "&student_class_stream=" +
                student_class_stream + "&session1=" + session1 + "&student_class_group=" + student_class_group;
            window.open(url2, '_blank');
        }
        if (value == 2) {
            var url2 = pdf_path + "marksheet_page/" + marksheet_final_all_pdf + "?class=" + student_class +
                "&section=" + student_class_section + "&exam_type=" + exam_type + "&student_class_stream=" +
                student_class_stream + "&session1=" + session1 + "&student_class_group=" + student_class_group;
            window.open(url2, '_blank');
        }
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="box box-primary my_border_top">
            ...
            <input type="hidden" id="marksheet_final_all_pdf" value="marksheet_final_all_demo.php">
            <input type="hidden" id="marksheet_exam_wise_all_pdf" value="marksheet_examwise_all_demo.php

">
            <div class="box-body ">
                <form role="form" id="add_employee" method="post" enctype="multipart/form-data">
                    <input type="hidden" id="session1" value="2022_23">
                    <input type="hidden" id="school_info_medium" value="English">
                    <div class="col-md-3 ">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <button class="form-control my_background_color" id="print_all_button_exam_wise"
                                onclick="print_all('1');" style="display:none;">Print All Exam Wise</button>
                            <button class="form-control my_background_color" style="display:none;" id="print_all_button"
                                onclick="print_all('2');">Print All Final</button>
