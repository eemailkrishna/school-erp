                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-primary"
                                                onclick="post_content('examination/view_weekly_test_detailed','s_no=23');">Edit</button>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-primary"
                                                onclick="post_content('examination/view_weekly_test_detailed','s_no=22');">Edit</button>
                                        </td>
                                        <td><button type="button" class="btn btn-danger"
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-primary"
                                                onclick="post_content('examination/view_weekly_test_detailed','s_no=21');">Edit</button>
                                        </td>
                                        <td><button type="button" class="btn btn-danger"
