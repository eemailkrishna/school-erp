...
function for_list() {
    ...
    if (student_class != '' && exam_type != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "examination/ajax_admit_card_list.php?class=" + student_class +
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            <label>Class</label>
                            <select name="admit_card_student_class"
                                onchange="for_stream(this.value);for_section(this.value);" id="student_class"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            <label>Section</label>
                            <select class="form-control" name="admit_card_student_section" id="student_class_section"
                                onchange='for_list();'>
