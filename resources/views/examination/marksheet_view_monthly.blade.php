...
function for_list() {
    ...
    if (student_class_section != '' && student_class != '' && exam_type != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "examination/ajax_view_marksheet_monthly.php?id=" + student_class +
...
function print_all(value) {
    ...
    if (student_class_section != '' && student_class != '' && exam_type != '') {
        ...
        if (value == 1) {
            var url2 = pdf_path + "marksheet_page/" + marksheet_exam_wise_monthly_all_pdf + "?class=" + student_class +
                ...
                <form role="form" id="add_employee" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <button class="form-control my_background_color" style="display:none;" id=""
