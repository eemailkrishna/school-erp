...
function for_list() {
    ...
    if (student_class_section != '' && student_class != '' && exam_type != '' && subject_name != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "examination/ajax_fill_marksheet_monthly.php?id=" + student_class +
                "&student_section=" + student_class_section + "&subject_name=" + subject_name +
                "&student_exam_type=" + exam_type + "&student_class_stream=" + student_class_stream +
                "&student_class_group=" + student_class_group + "&order_by=" + order_by + "",
            cache: false,
...
function for_subject() {
    ...
    $.ajax({
        address: "POST",
        url: access_link + "examination/ajax_get_subject.php?value=" + student_class +
            "&student_class_stream=" + student_class_stream + "&student_class_group=" + student_class_group +
            "&student_class_stream=" + student_class_stream + "&student_class_group=" + student_class_group +
            "",
        cache: false,
        success: function(detail) {
...
$("#my_form").submit(function(e) {
    ...
    loader();
    $.ajax({
        url: access_link + "examination/marksheet_fill_monthly_api.php",
        type: "POST",
        data: formdata,
        ...
        success: function(detail) {
            ...
            if (res[1] == 'success') {
                ...
                get_content('examination/marksheet_fill_monthly');
            }
        }
    });
});
                ...
                <form role="form" id="my_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-2 ">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Maximum Mark" name="student_maximum_marks"
                                id="student_maximum_marks" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-2 ">
                        <div class="form-group">
                            <label>Minimum Mark<font style="color:red"><b>*</b></font></label>
                            <input type="text" placeholder="Minimum Mark" name="student_minimum_marks"
                                id="student_minimum_marks" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-3 ">
                        <div class="form-group">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead class="my_background_color">
                                        <tr>
                                            ...
                                            <th>student Name</th>
                                            <th>Roll.No.</th>
                                            <th>Fill Mark<br /><span style="color:red;"><input type="checkbox" name=""
                                                        id="check_for_same" value="" /> <b>For Same</b></span></th>

                                            <th>Update By</th>
                                            <th>Date</th>
                                            <th><input type="checkbox" value="" id="sms_checked"
                                                    onclick="for_check(this.id);" /><b style="color:red;"> SMS All</b>
                                            </th>
