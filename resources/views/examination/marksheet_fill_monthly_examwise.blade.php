...
function for_list() {
    ...
    if (student_class_section != '' && student_class != '' && exam_type != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "examination/ajax_fill_marksheet_monthly_examwise.php?id=" + student_class +
                ...
                student_class_group + "&order_by=" + order_by + "&student_limit=" + student_limit + "",
            cache: false,
