...
function for_list() {
    ...
    if (student_class_section != '' && student_class != '' && exam_type != '' && subject_name != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "examination/ajax_fill_marksheet.php?id=" + student_class + "&student_section=" +
                student_class_section + "&subject_name=" + subject_name + "&student_exam_type=" + exam_type +
