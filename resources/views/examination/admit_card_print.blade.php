...
function for_list() {
    ...
    if (student_class != '' && exam_type != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "examination/ajax_admit_card_print.php?id=" + student_class +
                ...
                student_class_group + "&student_admission_type1=" + student_admission_type1 + "",
            cache: false,
    ...
    <div class="row">
        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-body ">
                ...
                <form role="form" action="../school_software_v1_old/pdf/pdf/admit_card/admit_card_pdf_individual_1.php"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" onchange='for_list();' name="student_admission_type1"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group" id="print_all" style="display:none;">
                            ...
                            <input type="submit" name="finish" value="Print All"
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead class="my_background_color">
                                        <tr>
                                            ...
                                            <th>Father's Name</th>
                                            <th>Class Roll No</th>
                                            <th>Select<input type="checkbox" id="checked1" checked value="" name=""
