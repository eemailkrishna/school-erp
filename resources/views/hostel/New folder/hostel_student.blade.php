...
<!------------------------------------------------Start Registration form--------------------------------------------------->
		...
		<div class="box-body">	
			...
			<h3 style="color:#d9534f;"><b>Student Admission In Hostel</b></h3>
				...
				<input type="hidden" name="hostel_student_id" placeholder="Unique Id"  value="_4" class="form-control" readonly>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text"  name="hostel_student_name" id="student_name" placeholder="Name"  value="" class="form-control" required>
					</div>
				</div>
				<div class="col-md-4">		
					<div class="form-group">
				       <label>Father's Name<font style="color:red"><b>*</b></font></label>
					   <input type="text" name="hotel_father_name" placeholder="Father's Name" id="student_father_name" value="" class="form-control" required>
					</div>
				</div>
				<div class="col-md-4">	
					<div class="form-group">
				...
				<div class="col-md-4 ">				
					 <div class="form-group" >
					  ...
					  <input type="text"  name="hostel_student_religion" id="student_religion" placeholder="Religion"  value="" class="form-control">
				 </div>
				 </div>
				<div class="col-md-4 ">				
					<div class="form-group" >
					  <label >Category</label>
					<input type="text"  name="hostel_student_category" id="student_category" placeholder="Category"  value="" class="form-control">
					</div>
				</div>
				<div class="col-md-4 ">				
					<div class="form-group" >
					  <label >Aadhar No.<font style="color:red"><b>*</b></font></label>
					  <input type="text"  name="hostel_student_aadhar" id="student_adhar_number" placeholder="Aadhar No."  value="" class="form-control" required>
					</div>
				</div>	
				<div class="col-md-4 ">				
					<div class="form-group" >
					  <label >Class<font style="color:red"><b>*</b></font></label>
					 <input type="text"  name="hostel_student_class" placeholder="Class" id="student_class" value="Class" class="form-control" required>
					</div>
				</div>
				<div class="col-md-4 ">				
					<div class="form-group">
					  <label >Father Contact No.<font style="color:red"><b>*</b></font></label>
					  <input type="text"  name="hostel_student_father_contact" id="student_father_contact_number" placeholder="Father Contact No."  value="" class="form-control" required>
					</div>
				</div>
				<div class="col-md-4 ">				
					<div class="form-group" >
					  <label >Father Email Id</label>
					  <input type="text"  name="hostel_student_father_email" id="student_father_email_id"  placeholder="Father Email Id"  value="" class="form-control">
					</div>
				</div>
				<div class="col-md-4 ">				
					<div class="form-group" >
					  <label >Mother's Name<font style="color:red"><b>*</b></font></label>
					  <input type="text"  name="hostel_student_mother_name" id="student_mother_name" placeholder="Mother's Name"  value="" class="form-control" required>
					</div>
				</div>
				<div class="col-md-4 ">				
					<div class="form-group" >
					  <label >Mother Contact No</label>
					  <input type="text"  name="hostel_student_mother_contact" id="student_mother_contact_number" placeholder="Mother Contact No"  value="" class="form-control">
					</div>
				</div>
				<div class="col-md-4 " style="display:none;">				
					<div class="form-group" >
					  <label ></label>
					  <input type="text"  name="hostel_student_contact" id="student_contact_number" placeholder=""  value="" class="form-control">
					</div>
				</div>
				<div class="col-md-4">				
					<div class="form-group">
					  <label>Student Email Id</label>
					  <input type="text"  name="hostel_student_email" id="student_email_id" placeholder="Student Email Id"  value="" class="form-control">
					</div>
				</div>
				<div class="col-md-4" style="display:none;">				
					<div class="form-group">
				...
				<div class="col-md-4 ">				
					<div class="form-group" >
					  ...
					  <input type="text"  name="hostel_emergency_contact" placeholder="Emergency Contact" value="Emergency Contact" class="form-control">
					</div>
				</div>
	        </div>
  ...
  <!-----------------------------------------------Model Box End------------------------------------------------------------>
	 ...
	 <h3 style="color:#d9534f;"><b>Hostel Info</b></h3>
		...
		<input type="text" name="hostel_name1" id="hostel_name1" placeholder="Hostel Name"  value="" class="form-control"  required>
	  </div>
		</div>
				<div class="col-md-4">
					<div class="form-group">
						<label>Room No.<font style="color:red"><b>*</b></font></label>
						<input type="text" name="hostel_room" id="hostel_room" placeholder="Room No."  value="" class="form-control"  readonly>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label>Room Bed Type<font style="color:red"><b>*</b></font></label>
						<input type="text" name="hostel_bed_type" id="hostel_bed_type" placeholder="Room Bed Type"  value="" class="form-control" required>
					</div>
				</div>
				<div class="col-md-4 ">
					<div class="form-group">
						<label>Facilities<font style="color:red"><b>*</b></font></label>
						<input type="text" name="hostel_room_facility" id="hostel_room_faci" placeholder="Facilities"  value="" class="form-control"  required />
					</div>
				</div>
				<div class="col-md-4 ">
					<div class="form-group">
