            ...
            <a href="{{ url('hostel_list') }}">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#E32636;">
                        ...
                        <a href="{{ url('hostel_list') }}" class="small-box-footer">More Info <i
            ...
            <a href="{{ url('room_list') }}">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3B7A57;">
                        ...
                        <a href="{{ url('room_list') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('seat_avail') }}">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#9F2B68;">
                        ...
                        <a href="{{ url('seat_avail') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ url('hostal_stu_list') }}">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#C46210;">
                        ...
                        <a href="{{ url('hostal_stu_list') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('hostal_mess') }}">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box" style="background-color:#3B3B6D;">
                        ...
                        <a href="{{ url('hostal_mess') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('hostel/hostel_daily_entry')">
                <div class="col-lg-3 col-xs-6" style="display:none;">
                    <div class="small-box" style="background-color:#34B334;">
                        ...
                        <a href="javascript:get_content('hostel/hostel_daily_entry')" class="small-box-footer">More Info
