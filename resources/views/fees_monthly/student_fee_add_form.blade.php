...
function call_me() {
    ...
    if (selected_student != '' && fee_month != '') {
        post_content('fees_monthly/student_fee_add_form', 'student_roll_no=' + selected_student + '&fee_month=' +
            fee_month + chk_all);
...
function payment_mode(value) {
    if (value == 'Cheque') {
        ...
        $('#for_transaction_no').hide();
    } else if (value == 'Paytm' || value == 'Phone Pay' || value == 'Google Pay' || value == 'Other Wallet' || value ==
        'Upi') {
...
function myFunction() {
    ...
    if (checkBox.checked == true) {
        ...
        $('#contact').val('Dear ' + student_name + ',Your Fee Amount ' + total_amount +
            ' Successfully deposited. Thanking You');
        $('#contact').val('Dear ' + student_name + ',Your Fee Amount ' + total_amount +
            ' Has Been Successfully Deposited. Thank You, From ' + school_name + ' [SIMPTION]');
    ...
    $.ajax({
        ...
        success: function(detail) {
            ...
            if (res[1] == 'success') {
                ...
                post_content('fees_monthly/student_fee_list_particular', 'student_roll_no=' + res[
                    2]);
        ...
        for (var j = 0; j < month_count; j++) {
            for (var i = 0; i < serial_no; i++) {
                if (Number($("#balance_tot_" + i + "_" + j).val()) <= Number(submission_amount)) {
                    submission_amount = Number(parseFloat(submission_amount) - parseFloat($("#balance_tot_" + i + "_" +
                        j).val()));
                    ...
                    <div class="box-body  col-md-12">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="" class="form-control select2" id="selected_student"
                                    onchange="for_dues1();call_me();" style="width:100%;" required>
                        ...
                        <div class="col-md-8">
                            <div class="col-md-12">
                                <span style="float:right;"><input type="checkbox" value="" id="fee_month"
                                        onclick="for_check(this.id);" /><b style="color:red;">Check All</b></span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="04" onclick="call_me();"> April
                                Month / <span style="color:red;font-weight:bold;" id="dues_04">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="05" onclick="call_me();"> May
                                Month / <span style="color:red;font-weight:bold;" id="dues_05">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="06" onclick="call_me();"> June
                                Month / <span style="color:red;font-weight:bold;" id="dues_06">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="07" onclick="call_me();"> July
                                Month / <span style="color:red;font-weight:bold;" id="dues_07">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="08" onclick="call_me();"> August
                                Month / <span style="color:red;font-weight:bold;" id="dues_08">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="09" onclick="call_me();">
                                September Month / <span style="color:red;font-weight:bold;" id="dues_09">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="10" onclick="call_me();"> October
                                Month / <span style="color:red;font-weight:bold;" id="dues_10">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="11" onclick="call_me();"> November
                                Month / <span style="color:red;font-weight:bold;" id="dues_11">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="12" onclick="call_me();"> December
                                Month / <span style="color:red;font-weight:bold;" id="dues_12">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="01" onclick="call_me();"> January
                                Month / <span style="color:red;font-weight:bold;" id="dues_01">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="02" onclick="call_me();"> February
                                Month / <span style="color:red;font-weight:bold;" id="dues_02">0</span>
                            </div>

                            <div class="col-md-3">
                                <input type="checkbox" id="" class="fee_month" value="03" onclick="call_me();"> March
                                Month / <span style="color:red;font-weight:bold;" id="dues_03">0</span>
                            </div>
                        </div>
                    </div>
