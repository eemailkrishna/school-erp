	  ...
	  <div class="box">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#6E666C;">
            ...
            <div class="icon">
              <i class="ion"><img src="../school_software_v1_old/images/fee_structure.png" style="width:80px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "  title="School Management System" class="image1"></i>
            </div>
	  ...
	  <a href="javascript:get_content('fees_monthly/fee_structure_list')">
        ...
        <div class="col-lg-3 col-xs-6" style="display:none;">
          <div class="small-box" style="background-color:#3B7A57;">
            ...
            <div class="icon">
              <i class="ion"><img src="../school_software_v1_old/images/discount_structure.png" style="width:80px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "  title="School Management System" class="image1"></i>
            </div>
            <a href="javascript:get_content('fees_monthly/discount_types_list')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#9F2B68;">
            ...
            <div class="icon">
              <i class="ion"><img src="../school_software_v1_old/images/pay_fee.png" style="width:80px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "  title="School Management System" class="image1"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#8F9D32;">
            ...
            <a href="javascript:get_content('fees_monthly/student_fee_dues_list_statuswise')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
	  ...
	  <div class="box">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#5A5554;">
            ...
            <div class="icon">
              <i class="ion"><img src="../school_software_v1_old/images/bus_staff.png" style="width:80px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "  title="School Management System" class="image1"></i>
            </div>
		...
		<a href="userhelp/Fee Panel.pdf" target="_blank">
					<div class="col-lg-3 col-xs-6">
						...
						<div class="icon">
							...
							<a href="userhelp/Fee Panel.pdf" target="_blank" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
					...
					<div class="col-lg-3 col-xs-6">
						...
						<div class="icon">
							...
							<a href="userhelp/Fee Panel hindi.pdf" target="_blank"" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					</a>
