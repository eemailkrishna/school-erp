    ...
    <section class="content">
      ...
      <div class="row">
		...
		<center><h4 style="color:red;">Pay Fee</h4></center>
            <script>alert('Student Fee Has Not Set Please Set It Firstly');</script><script>post_content('fees_monthly/set_fee_details','student_roll_no='+2000296);</script>								
				...
				<div class="form-group">
                  ...
                  <input type="text"  name="student_transport_fee" value="" placeholder="Transport Fee" id=""  class="form-control" readonly />
                </div>
				</div>
				...
				<div class="form-group">
                  ...
                  <input type="text" name="student_transport_fee_balance" value="" placeholder="Transport Fee Balance" id=""  class="form-control" readonly />
                </div>
				</div>
				...
				<div class="form-group">
                  ...
                  <input type="number"  name="transport_fee_paid" value="" placeholder="0" step="1" max="" oninput="total_fee();" id="transport_fee_paid1" class="form-control amt"  />
                </div>
				</div>
		        </div>
		    ...
		    <div class="col-md-12">
				...
				<div class="form-group">
                  ...
                  <input type="number" name="editable_fee_receipt_no" placeholder="" value="261" class="form-control" >
                </div>
                </div>
				<div class="col-md-2">
				<div class="form-group">
                  <label>Fee submission Date</label>
                  <input type="date" name="fee_submission_date" value="2022-12-05" onchange="for_penalty(this.value);" class="form-control"  >
                </div>
                </div>
				...
				<div class="col-md-2" style="display:none;">
                  ...
                  <input type="text"  name="school_name" placeholder="school_name" id="school_info_school_name11" value="SIMPTION TECH PVT LTD" class="form-control" readonly/>
                </div>
                </div>
			 ...
			 <div class="col-md-1">				
		      <div class="form-group">
                  <label>Penalty</label>
                  <input type="text" name="penalty_fee" id="penalty_fee" placeholder="0" value="" class="form-control amt" oninput="total_fee();">
                </div>
             </div>
		      ...
		      <div class="form-group">
		        ...
		        <div class="col-md-12 ">
		            <div class="col-md-3">				
        		      <div class="form-group">
                          ...
                          <input type="number" placeholder="Enter Pay Amount" id="submission_amount" class="form-control" oninput="for_paid('7','');" />
                        </div>
                     </div>
		        </div>
		        ...
		        <div class="box-body">
			       <div class="col-md-12">
				    ...
				    <input type="hidden" name="student_transport_fee_paid_total" value="" />
				    <input type="hidden" name="paid_total" value="0" />
				    <input type="hidden" name="month_count111" value="" />
				    <input type="hidden" name="month" value="04" />
				    <input type="hidden" name="editable_blank_field_column_name" value="editable_blank_field_5" />
