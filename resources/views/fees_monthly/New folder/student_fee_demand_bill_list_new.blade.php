...
function print_list(){
	...
	if(student_class!='' && student_class_section!='' && student_due_month!=''){
		$.ajax({
		type: "POST",
		url: access_link+"fees_monthly/ajax_get_student_demand_bill_list_for_print_new.php",
		data:{student_class:student_class,student_class_section:student_class_section,student_bus:student_bus,student_due_month:student_due_month,student_note:student_note,for_prev_amt:for_prev_amt},
		cache: false,
		success: function(detail){
...
function print_list2(){
	...
	if(student_class!='' && student_class_section!='' && student_due_month!=''){
		...
		cache: false,
		data:{student_roll_no:student_roll_no,student_class:student_class,student_class_section:student_class_section,student_bus:student_bus,student_due_month:student_due_month,student_note:student_note,for_prev_amt:for_prev_amt},
		success: function(detail){
		$("#student_list").html(detail);
		}
		});
      ...
      <div class="row">
		...
		<div class="box-body  col-md-12">
			...
			<div class="col-md-1">				
				<div class="form-group" >
				  <label>Section</label>
				  <select name="student_class_section" class="form-control" id="student_class_section" onchange="" required>
		...
		<div class="col-md-4"><h3>Select Months</h3></div>
		<div class="col-md-4"><span style="color:red;float:right;"><input type="checkbox" id="month" value="" onclick="for_check(this.id);" /> All Check / Uncheck</span></div>
		<div class="col-md-4"><span style="color:blue;float:right;"><input type="checkbox" id="for_prev_amt" value="" /> For Previous Amount</span></div>
		</div>
		
		<div class="col-md-10 col-md-offset-1">
		    
            		    <div class="col-md-3">				
				<input type="checkbox" name="" value="04" class="month" /> April Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="05" class="month" /> May Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="06" class="month" /> June Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="07" class="month" /> July Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="08" class="month" /> August Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="09" class="month" /> September Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="10" class="month" /> October Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="11" class="month" /> November Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="12" class="month" /> December Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="01" class="month" /> January Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="02" class="month" /> February Month			</div>
					    <div class="col-md-3">				
				<input type="checkbox" name="" value="03" class="month" /> March Month			</div>
