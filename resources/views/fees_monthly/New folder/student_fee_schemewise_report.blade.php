...
var admission_scheme=document.getElementById('student_admission_scheme').value;
...
$("#div_from_date").show();
$("#div_to_date").show();
$("#search_detail").removeClass('col-md-12 col-md-offset-3').addClass('col-md-12 col-md-offset-1');
$("#pdf_detail").html('');

if(class_name!='' && section_name!='' && from_date!='' && to_date!='' && admission_scheme!=''){
$("#pdf_detail").html(loader_div);
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_schemewise_report_random.php?class_name="+class_name+"&section_name="+section_name+"&from_date="+from_date+"&to_date="+to_date+"&admission_scheme="+admission_scheme+"&order_by="+order_by+"",
	  cache: false,
	  success: function(detail){
...
if(class_name!='' && section_name!='' && admission_scheme!=''){
$("#pdf_detail").html(loader_div);
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_schemewise_report_installmentwise.php?class_name="+class_name+"&section_name="+section_name+"&admission_scheme="+admission_scheme+"&order_by="+order_by+"",
	  cache: false,
	  success: function(detail){
		 $("#pdf_detail").html(detail);
	  }
...
function for_print()
 ...
 newWin.close();
    ...
    <section class="content-header">
      <h1>
        Download Schemewise Fee Report
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-user-plus"></i>Schemewise Report</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <div class="col-md-4"><h3 class="box-title">Schemewise Fee Report download</h3></div>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12 col-md-offset-1" id="search_detail">
				...
				<div class="col-md-1" id="div_schemewise">
				<div class="form-group">
				<label>Scheme</label>
