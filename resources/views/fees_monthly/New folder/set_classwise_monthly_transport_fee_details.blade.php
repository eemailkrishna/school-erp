...
function for_feedetails(){
   ...
   $.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_set_classwise_monthly_transport_fee_details.php?class_name="+class_name+"&student_class_stream="+student_class_stream+"&student_class_section="+student_class_section+"",
	  cache: false,
	  success: function(detail){
...
<center>
<input type="checkbox" name="transport_fee_head" class="my_head" value="fee3" > Transport fees</center>
				</div>
