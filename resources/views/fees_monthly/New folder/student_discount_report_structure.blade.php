...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_discount_report_structure.php?class_name="+class_name+"&section_name="+section_name+"&month_code="+month_code+"&order_by="+order_by+"",
	  cache: false,
	  success: function(detail){
