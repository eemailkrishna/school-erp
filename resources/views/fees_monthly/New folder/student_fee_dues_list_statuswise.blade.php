...
function for_msg(){
	...
	$("#student_message").val("Sir, Kindly deposit the due fees Rs ? and transport fee Rs ? "+for_late_fee+"of your child ?. Regards, PNPS");
	}else{
// 	$("#student_message").val("Dear Parents, Kindly deposit the "+month_arr+" due fees amount ? and transport dues amount ? "+for_late_fee+"of your child ? at the earliest. Regards, "+school_name);
 	$("#student_message").val("Dear Parents, Kindly deposit the  due fees amount ? and transport dues amount ? of your child ? at the earliest. From "+school_name+" [SIMPTION]");
	}
...
function student_list(){
	...
	if(student_class!='' && student_class_section!='' && selected_month!='' && head_value!=''){
		...
		data: { student_class:student_class,student_class_section:student_class_section,student_status:student_status,selected_month:selected_month,head_value:head_value,late_fee:late_fee },
		cache: false,
		success: function(detail){
...
function print_list(){
	...
	if(student_class!='' && student_class_section!='' && selected_month!='' && head_value!=''){
		...
		data: { student_class:student_class,student_class_section:student_class_section,student_status:student_status,selected_month:selected_month,head_value:head_value,student_note:student_note,late_fee:late_fee },
		cache: false,
		success: function(detail){
		$("#student_list").html(detail);
		}
...
function print_list2(){
	...
	if(student_class!='' && student_class_section!='' && selected_month!='' && head_value!=''){
		...
		cache: false,
		data: { student_class:student_class,student_class_section:student_class_section,student_status:student_status,selected_month:selected_month,head_value:head_value,student_note:student_note,student_roll_no : student_roll_no,late_fee:late_fee },
		success: function(detail){
		$("#student_list").html(detail);
		}
		});
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            ...
            <!-- /.box-header -->			
        <div class="box-body">
		<div class="col-md-12" style="display:none;"><span style="float:right;color:red;"><input type="checkbox" name="late_fee" id="late_fee" onclick="for_msg();" /> Late Fee</span></div>
		...
		<div class="box-body  col-md-12">
		    <div class="col-md-8" style="border:1px solid;border-radius:15px;">
		        ...
		        <div class="col-md-2"><span style="float:right;font-weight:bold;color:red;"><input type="checkbox" name="" id="my_month" onclick="for_check(this.id,'Yes');" /> All</span></div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="04" class="my_month" onclick="for_msg();" /> April Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="05" class="my_month" onclick="for_msg();" /> May Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="06" class="my_month" onclick="for_msg();" /> June Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="07" class="my_month" onclick="for_msg();" /> July Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="08" class="my_month" onclick="for_msg();" /> August Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="09" class="my_month" onclick="for_msg();" /> September Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="10" class="my_month" onclick="for_msg();" /> October Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="11" class="my_month" onclick="for_msg();" /> November Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="12" class="my_month" onclick="for_msg();" /> December Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="01" class="my_month" onclick="for_msg();" /> January Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="02" class="my_month" onclick="for_msg();" /> February Month</div>
                                <div class="col-md-3"><input type="checkbox" name="select_month[]" value="03" class="my_month" onclick="for_msg();" /> March Month</div>
                		    </div>
		    <div class="col-md-4" style="border:1px solid;border-radius:15px;">
		        <div class="col-md-12"><h4>Select Head</h4></div>
		        <div class="col-md-6"><input type="radio" name="select_head" value="yearly_head" class="my_head" checked /> Yearly Transport Fee</div>
		        				<div class="col-md-6"><input type="radio" name="select_head" value="fee3" class="my_head" /> Transport fees</div>
								<div class="col-md-6"><input type="radio" name="select_head" value="fee9" class="my_head" /> bus fee</div>
						    </div>
		</div>
