	  ...
	  <div class="box">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#402B27;">
            ...
            <div class="icon">
              <i class="ion"><img src="../school_software_v1_old/images/fee_details.png" style="width:80px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "  title="School Management System" class="image1"></i>
            </div>
            <a href="javascript:get_content('fees_monthly/student_fee_daily_collection_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#15687B;">
            ...
            <a href="javascript:get_content('fees_monthly/student_fee_daily_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#7348A4;">
            ...
            <a href="javascript:get_content('fees_monthly/student_fee_monthly_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#1EABA6;">
            ...
            <a href="javascript:get_content('fees_monthly/student_fee_schemewise_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#A49D05;">
            ...
            <a href="javascript:get_content('fees_monthly/student_fee_classwise_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#BF0766;">
            ...
            <a href="javascript:get_content('fees_monthly/student_daily_report_headwise')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#606E1B;">
            ...
            <a href="javascript:get_content('fees_monthly/student_balance_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#34023E;">
            ...
            <a href="javascript:get_content('fees_monthly/student_headwise_balance_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#C17015;">
            ...
            <a href="javascript:get_content('fees_monthly/student_discount_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#1E5A31;">
            ...
            <a href="javascript:get_content('fees_monthly/student_discount_report_headwise')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#B20606;">
            ...
            <a href="javascript:get_content('fees_monthly/student_discount_report_structure')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#374746;">
            ...
            <a href="javascript:get_content('fees_monthly/student_bus_fee_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#53C88C;">
            ...
            <a href="javascript:get_content('fees_monthly/student_fee_structure_download')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#73253C;">
            ...
            <a href="javascript:get_content('fees_monthly/student_transport_structure_download')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#626567;">
            ...
            <a href="javascript:get_content('fees_monthly/student_rangewise_balance_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#1C0D39;">
            ...
            <a href="javascript:get_content('fees_monthly/student_familywise_balance_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#86591B;">
            ...
            <a href="javascript:get_content('fees_monthly/student_overall_report_studentwise')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#7F7C61;">
            ...
            <a href="javascript:get_content('fees_monthly/student_overall_report_classwise')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
		
		<a href="javascript:get_content('fees_installmentwise/demand_notes')">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#353104;">
            ...
            <a href="javascript:get_content('fees_installmentwise/demand_notes')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
     ...
     <a href="javascript:get_content('fees_monthly/student_fee_daily_paytime_discount_report')">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#402B27;">
            ...
            <a href="javascript:get_content('fees_monthly/student_fee_daily_paytime_discount_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
     <a href="javascript:get_content('fees_monthly/student_daily_collection_report_dcr')">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#800519;">
            ...
            <a href="javascript:get_content('fees_monthly/student_daily_collection_report_dcr')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
     ...
     <a href="javascript:get_content('fees_monthly/student_deleted_fee_reciept_report')">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#800519;">
            ...
            <a href="javascript:get_content('fees_monthly/student_deleted_fee_reciept_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
