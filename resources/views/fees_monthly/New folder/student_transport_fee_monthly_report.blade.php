...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_transport_fee_daily_report_random.php?class_name="+class_name+"&section_name="+section_name+"&from_date="+from_date+"&to_date="+to_date+"&order_by="+order_by+"&user_detail="+user_detail+"",
	  cache: false,
	  success: function(detail){
...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_transport_fee_daily_report_installmentwise.php?class_name="+class_name+"&section_name="+section_name+"&std_installment="+std_installment+"&order_by="+order_by+"&user_detail="+user_detail+"",
	  cache: false,
	  success: function(detail){
		 $("#pdf_detail").html(detail);
	  }
 ...
 newWin.close();
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-user-plus"></i>Transport Monthly Report</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <div class="col-md-4"><h3 class="box-title">Transport Fee Monthly Report download</h3></div>
              <div class="col-md-2"><center><input type="radio" name="list_type" value="Installmentwise" class="list_type" onclick="for_list();" checked /> <b>Monthwise</b></center></div>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12" id="search_detail">
				...
				<input type="date" name="from_date" id="from_date" value="2022-12-01" class="form-control" oninput="for_list();" />
				</div>
				</div>
				...
				<div class="form-group">
				<label>To Date</label>
				<input type="date" name="to_date" id="to_date" value="2022-12-31" class="form-control" oninput="for_list();" />
				</div>
				</div>
