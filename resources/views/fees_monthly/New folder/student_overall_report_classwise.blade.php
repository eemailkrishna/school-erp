...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_overall_report_classwise.php?class_name="+class_name+"&section_name="+section_name+"&order_by="+order_by+"",
	  cache: false,
	  success: function(detail){
...
function for_print()
 ...
 newWin.close();
    ...
    <section class="content-header">
      <h1>
        Download Overall Report Classwise
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-user-plus"></i>Overall Report Classwise</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title">Overall Report Classwise download</h3>
            </div>
            <!-- /.box-header -->
