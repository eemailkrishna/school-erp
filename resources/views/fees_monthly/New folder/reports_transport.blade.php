	  ...
	  <div class="box">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="small-box" style="background-color:#402B27;">
            ...
            <a href="javascript:get_content('fees_monthly/student_transport_daily_collection_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="small-box" style="background-color:#15687B;">
            ...
            <a href="javascript:get_content('fees_monthly/student_transport_fee_daily_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="small-box" style="background-color:#7348A4;">
            ...
            <a href="javascript:get_content('fees_monthly/student_transport_fee_monthly_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="small-box" style="background-color:#A49D05;">
            ...
            <a href="javascript:get_content('fees_monthly/student_transport_fee_classwise_report)" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="small-box" style="background-color:#606E1B;">
            ...
            <a href="javascript:get_content('fees_monthly/student_transport_balance_report')" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
		</div>
