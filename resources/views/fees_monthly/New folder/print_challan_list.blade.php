...
function check_valid(){
	...
	<!---******************************************************************************************************-->
<form method="post" action="../school_software_v1_old/pdf/pdf/challan_pdf/challan_pdf_monthly.php" enctype="multipart/form-data" target="_blank">
      ...
      <div class="box box-primary my_border_top">
			...
			<div class="col-md-12 col-md-offset-1">
                ...
                <option value="">Select Bank</option>
                                ...
                                <option  value="53">kanhar valley public school[sbi]-[bpl]-[7740047]-[sbin000440]</option>
                                <option  value="54">NIDHI SINGH[BANK OF INDIA]-[BOI]-[1524624524515]-[ifsc234]</option>
                                <option  value="56">Rajat Sharma [Union bank ]-[Raisen ]-[45789654123541]-[Un1025482]</option>
                                <option  value="57">Pokhari[abc]-[abc]-[100]-[111]</option>
                                <option  value="58">Laxman[Hari Bank]-[ccc]-[1010]-[cccc]</option>
                                <option  value="59">Jalgaon Jamod Secondary and Higher Secondary School[Jalgaon Jamod Urban Cooprative Bank Pvt. Ltd.]-[Jalgaon Jamod Main Branch]-[123456789012345]-[HDFC0CJJUCB]</option>
                                <option  value="60">hemant[rahu sir]-[dev sir]-[987654321456987]-[9074]</option>
                                <option  value="61">Sushil[STATE BANK OF INDIA]-[Delhi]-[89878767655555555]-[456546546]</option>
			...
			<div class="col-md-12 col-md-offset-1">
                ...
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="04" onclick="student_list();" /> April Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="05" onclick="student_list();" /> May Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="06" onclick="student_list();" /> June Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="07" onclick="student_list();" /> July Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="08" onclick="student_list();" /> August Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="09" onclick="student_list();" /> September Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="10" onclick="student_list();" /> October Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="11" onclick="student_list();" /> November Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="12" onclick="student_list();" /> December Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="01" onclick="student_list();" /> January Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="02" onclick="student_list();" /> February Month                </div>
                                
                <div class="col-md-2">
                <input type="checkbox" name="fee_months[]" id="" class="fee_month" value="03" onclick="student_list();" /> March Month                </div>
                                </div>
