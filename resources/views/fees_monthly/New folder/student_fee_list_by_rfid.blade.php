          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <div class="col-md-6 col-md-offset-3">
				...
				<div class="col-md-5">
				<input type="text" name="" id="rfid_no" class="form-control" oninput="get_details();" placeholder="RFID No." autofocus required />
				</div>
				<div class="col-md-5">
				<select name="" id="" class="form-control select2" style="width:100%;" onchange="fill_detail(this.value);">
				<option value="">Select Student</option>
								<option value="IES0001PK">Palak Kumari[]-[2ND-B]-[Krishna Sahani-9876543210]</option>
								...
								<option value="0014944965">balveer singh[12372]-[LKG-A]-[sukhvinder singh-9144555977]</option>
								<option value="0014806624">ishan kumar[120009]-[2ND-A]-[rohit kumar-9816870719]</option>
								<option value="0012660095">Mayur Mangesh Padvi[120012]-[2ND-A]-[Mangesh Gorakh Padvi-7773954846]</option>
								...
								<option value="577711111111111">Prashant  KUMAR[12561]-[5TH-A]-[Rammu lal-7744447774]</option>
								<option value="0009240208">aashu []-[3RD-A]-[-1234567891]</option>
								<option value="12345">Rituraj[126593]-[2ND-A]-[mitu raj-9875455522]</option>
								<option value="744444740000">Prashant  KUMAR[]-[2ND-A]-[Rammu lal-7748908646]</option>
								...
								<option value="0010317118">Farhan khan[1265701]-[8TH-A]-[Riyaz khan-458963248327]</option>
								<option value="0002847890">Ariz[2]-[UKG-A]-[-]</option>
								<option value="0012022978">Amit rao[]-[2ND-A]-[Sahab rao-9450673349]</option>
								<option value="0007113750">Aarunya Raj Sinha[]-[UKG-A]-[tret-87874545454]</option>
								</select>
				</div>
				<div class="col-md-2">
				<button type="button" name="" id="" class="btn btn-default my_background_color" onclick="get_content('fees_monthly/student_fee_list_by_rfid');">Reset</button>
				</div>
				</div>
				</div>
