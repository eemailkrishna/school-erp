...
<a href="javascript:get_content('fees_monthly/set_classwise_fee_details')"><button type="button" style="float:right;" class="btn btn-success">Classwise Set Fee</button></a>
<a href="javascript:get_content('fees_monthly/student_admission_fee_list')"><button style="float:right;" type="button" class="btn btn-info my_background_color" >Reset</button></a>
<button style="float:right;" type="button" class="btn btn-info my_background_color" data-toggle="collapse" data-target="#demo">Filter</button>
</div>
...
<div class="col-md-4" id="student_class_stream_div" style="display:none;">				
	<div class="form-group">
	  <label >Stream<font style="color:red"><b>*</b></font></label>
		<select class="form-control" name="student_class_stream" id="student_class_stream" onchange="get_group(this.value);" required>
			   <option  value="All">All</option>
