...
function for_feedetails() {
    ...
    if (class_name != '' && student_class_stream != '' && student_class_section != '') {
        $.ajax({
            type: "POST",
            url: access_link + "fees_monthly/ajax_set_classwise_monthly_transport_fee_details.php?class_name=" +
                class_name + "&student_class_stream=" + student_class_stream + "&student_class_section=" +
                    ...
                    <div class="box-body">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="student_class_stream"
                                        id="student_class_stream" style="width:100%;" onchange="for_feedetails();">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="student_class_section" id="student_class_section" class="form-control"
                                        onchange="for_feedetails();" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <center>
                                    <input type="checkbox" name="transport_fee_head" class="my_head" value="fee3">
                                    Transport fees
                                </center>
                            </div>
