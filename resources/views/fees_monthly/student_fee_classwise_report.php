...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_fee_daily_report_random.php?class_name="+class_name+"&section_name="+section_name+"&from_date="+from_date+"&to_date="+to_date+"&order_by="+order_by+"&payment_mode="+payment_mode+"",
	  cache: false,
	  success: function(detail){
	   //   console.log(detail);
...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_classwise_fee_report_installmentwise.php?class_name="+class_name+"&section_name="+section_name+"&order_by="+order_by+"&payment_mode="+payment_mode+"",
	  cache: false,
	  success: function(detail){
