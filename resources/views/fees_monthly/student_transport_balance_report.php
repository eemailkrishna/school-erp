...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_transport_balance_report.php?class_name="+class_name+"&section_name="+section_name+"&month_code="+month_code+"&order_by="+order_by+"",
	  cache: false,
	  success: function(detail){
 ...
 newWin.close();
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-user-plus"></i>Transport Balance Report</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title">Transport Balance Report download</h3>
            </div>
            <!-- /.box-header -->
