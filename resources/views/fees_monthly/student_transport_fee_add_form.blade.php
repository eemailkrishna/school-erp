...
function call_me() {
    ...
    if (selected_student != '' && fee_month != '') {
        post_content('fees_monthly/student_transport_fee_add_form', 'student_roll_no=' + selected_student +
            '&fee_month=' + fee_month + chk_all);
...
function for_dues1() {
    ...
    $.ajax({
        type: "POST",
        url: access_link + "fees_monthly/ajax_get_student_transport_dues_amount.php?student_rollno=" +
            student_rollno + "",
        cache: false,
    ...
    $.ajax({
        ...
        success: function(detail) {
            ...
            if (res[1] == 'success') {
                ...
                post_content('fees_monthly/student_transport_fee_list_particular',
                    'student_roll_no=' + res[2]);
            }
        }
    });
});
