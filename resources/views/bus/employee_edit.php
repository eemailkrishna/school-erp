...
<!--------------------------------Start Registration form--------------------------------------------------->
    ...
    <div class="box-body "  >
		...
		<h3 style="color:#d9534f;"><b>Personal Detail</b></h3>
			<div class="col-md-4 ">
			    <input type="hidden" name="s_no" value="23" class="form-control">
				<div class="form-group">
                    <label>Employee Name<font style="color:red"><b>*</b></font></label>
                    <input type="text" required name="emp_name" placeholder="Employee Name"  value="Kamlesh Nayaka" class="form-control">
                </div>
			...
			<div class="col-md-4 ">		
				<div class="form-group">
                    ...
                    <input type="date" name="emp_dob" placeholder="Date of Birth"  value="2021-02-13" class="form-control">
                </div>
			</div>
			<div class="col-md-4 ">	
				<div class="form-group">
                    <label>Husband/Father's Name</label>
                    <input type="text" name="emp_father" placeholder="Father/Husband Name"  value="Nanajibhai" class="form-control">
                </div>
			</div>
			<div class="col-md-4 ">				
				<div class="form-group">
                    <label>Email Address </label>
                    <input type="email" name="emp_email" placeholder="Email Address"  value="kamaleshbhai@gmail.com" class="form-control">
                </div>
			</div>
			<div class="col-md-4 ">				
				<div class="form-group">
                    <label>Mobile No.<font style="color:red"><b>*</b></font></label>
                    <input type="text" required name="emp_mobile" placeholder="Mobile No"  value="8976543290" class="form-control">
                </div>
			</div>	
			<div class="col-md-4 ">				
				<div class="form-group">
                   <label>Address</label>
                   <input type="text" name="emp_address" placeholder="Address"  value="vapi " class="form-control">
                </div>
			</div>
			<div class="col-md-4 ">				
				<div class="form-group">
                    <label>Employee Qualification</label>
                    <input type="text" name="emp_qualification" placeholder="Employee Qualification"  value="10 th Pass" class="form-control">
                </div>
			</div>
			<div class="col-md-3 ">				
			 	<div class="form-group">
			...
			<div class="col-md-1 "  >	
					<div class="form-group">
					   <img id="emp_phroi12" src='https://simptionerp.com/data-content/simptionschoolerp/demo/employee_document/88820658_IMG_20210123_133121.jpg' width='60px' height='60px' >
					</div>
				</div>	
		</div>	
		   <div class="col-md-4 ">				
				<div class="form-group">
                    ...
                    <input type="date" name="emp_doj" placeholder=""  value="2021-02-13" class="form-control">
                </div>
			</div>
			<div class="col-md-4 ">				
				<div class="form-group">
                   <label>Designation</label>
                   <input type="text" name="emp_designation" placeholder="Designation"  value="Driver" class="form-control">
                </div>
			</div>
		...
		<h3 style="color:#d9534f;"><b>Salary Details</b></h3>
			...
			<div class="col-md-4 ">				
				<div class="form-group">
                   ...
                   <input type="text" required name="emp_basic_salary" placeholder="Salary"  value="10000" class="form-control">
                </div>
			</div>
