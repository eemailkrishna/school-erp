        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-body ">
                <form role="form" method="post" id="my_form"
                    action="../school_software_v1_old/pdf/pdf/id_card_page/id_card_pdf_staff.php"
                    enctype="multipart/form-data" target="_blank">

                    <div class="col-md-3 ">
                        <div class="form-group">
                            <label>Categories</label>
                            <select name="emp_categories" onchange="for_list();" id="emp_categories"
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Employee Name</th>
                                            <th>Select Employee &nbsp;<input type="checkbox" id="checked1" checked
                                                    value="" name="" onclick="for_check(this.id);"></th>
                                        </tr>
                                    </thead>
