                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="" class="form-control select2" onchange="fill_detail();" id="employee_id">
                                    ...
                                    select * from employee_info where emp_status='Active' ORDER BY s_no DESC <option
                                        value="123341">suresh Devashi[123341]-[Driver]-[9820964914]</option>
                                    ...
                                    <option value="RP34641645336">PARVATI PATIL[RP34641645336]-[Teacher]-[7477010621]
                                    </option>
                                    ...
                                    <option value="789456123216320">shamli [789456123216320]-[Teacher]-[6359874129]
                                    </option>
