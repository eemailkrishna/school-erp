          ...
          <div <div class="box box-success" >>
            ...
            <div class="box-body table-responsive">
			  ...
			  <div class="panel-body">
				...
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="" placeholder="Priority" /></td>
				</tr>
								<tr>
				...
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="-1" placeholder="Priority" /></td>
				</tr>
								<tr>
				...
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="-11" placeholder="Priority" /></td>
				</tr>
								<tr>
				...
				<td><input type="text" name="emp_name[]" class="form-control" value="JAGMAL YADAV" readonly /></td>
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="0" placeholder="Priority" /></td>
				</tr>
								<tr>
				...
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="2" placeholder="Priority" /></td>
				</tr>
								<tr>
				...
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="24" placeholder="Priority" /></td>
				</tr>
								<tr>
				...
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="25" placeholder="Priority" /></td>
				</tr>
								<tr>
				...
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="3" placeholder="Priority" /></td>
				</tr>
								<tr>
				...
				<td><input type="number" name="emp_attendance_priority[]" class="form-control" value="6" placeholder="Priority" /></td>
				</tr>
								</tbody>
				<tfoot>
