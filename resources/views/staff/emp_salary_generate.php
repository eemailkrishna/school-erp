...
function for_pf(){
 ...
 <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
	...
	<input type="hidden" name="pf_number"  value="">
	<input type="hidden" name="emp_id"  value="340">
	<input type="hidden" id="my_database_name" value="simpt5nk_demo">
    ...
    <div class="box-body">
				  ...
				  <div class="panel-body">
					<div class="col-md-6 ">
						<div class="form-group">
						  <input type="hidden" name="staff_id" id="staff_id" value="340">
						  <label> Employee Name :<font style="color:red"><b>*</b></font></label>
						  <input type="text" required name="emp_name" placeholder="Employee Name"  value="VIVEK KUMAR" class="form-control">
						  <input type="hidden" name="emp_account_no" value="" class="form-control" />
						  <input type="hidden" name="emp_ifsc_code" value="" class="form-control" />
						</div>
					</div>
					<div class="col-md-6 ">
						<div class="form-group">
						  <label  > Salary From :</label>
						  <input type="date" name="salary_from" id="salary_from" class="form-control" required value="2022-12-13" oninput="valid_month();">
						</div>
					</div>
					<div class="col-md-6 ">		
						<div class="form-group">
					...
					<div class="form-group" >
					  <label  > Salary :</label>
					  <td><input type="text" name="actual_salary" id="actual_salary" placeholder=" Actual Salary" oninput='salary_calculation();' class="form-control"  value="0"></td>
					</div>
					</div>
					<div class="col-md-6 ">	
					<div class="form-group" >
	       ...
	       <div class="col-md-6 ">				
				...
				<div class="form-group">
                   <label >PF Deduction</label>
				    ...
				    <input type="text" name="pf_amount_input" class="form-control" id="pf_amount_input" oninput='salary_calculation();' value="0">
       ...
       <div class="col-md-6 " >			
					...
					<div class="form-group" >
					  ...
					  <td><input type="date" name="salery_generate_date" class="form-control" value="2022-12-13"></td>
					</div>
					</div>
					...
					<div class="form-group" >
					  ...
					  <td><input type="date" name="cheque_date" class="form-control" placeholder="Cheque Date" value="2022-12-13"></td>
					</div>
					</div>
				...
				<div class="col-md-6 ">
				  ...
				  <div class="panel panel-default">
					...
					<div class="form-group" >
					  ...
					  <center><h4 style="color:#E67E22"><b>0</b></h4></center>
					</div>
					</div>
