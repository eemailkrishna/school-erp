...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('income_or_expence_list')}}"><i class="fa fa-list"></i>List</a></li>
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="office_account_info" class="form-control">
                                ...
                                <option value="59">Jalgaon Jamod Secondary and Higher Secondary School ( 123456789012345
                                    )</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control">
                                <input type="radio" name="account_party_type" id="" value="Other"
                                    onclick="party_select(this.value);"
                                    checked>&nbsp;&nbsp;<b>Other</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                    ...
                    <div class="col-md-4" style="display:none" id="student_select">
                        <div class="form-group">
                            ...
                            <select name="account_student_select" class="form-control select2" id="student_select1"
                                ...
                                <option value="2200795">Druwa Ganesh Chaudhari[2200795]-[NURSERY-A]-[Ganesh Chaudhari]
                                </option>
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_customer_address" id="student_adress1"
                                placeholder="Address" value="" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="number" name="account_customer_total_amount" id="account_customer_total_amount"
                                oninput="same_amount(this.value,'advance_amount');" placeholder="Total Amount" value=""
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="account_customer_date" placeholder="Date" value="2022-12-03"
                                class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="file" name="bill_upload" id="bill_upload" placeholder=""
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <img id="show_bill_upload" src='../../school_software_v1_old/images/student_blank.png'
