...
function for_list() {
    ...
    if (from_date != '' && to_date != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "account/ajax_ledger_advance_salary_report.php?from_date=" + from_date +
                "&to_date=" + to_date + "",
            cache: false,
...
<section class="content-header">
    <h1>
        Download Advance Salary Report
        <small>Control Panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{url('/')}}"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="{{url('/account')}}"><i class="fa fa-money"></i> Account Panel</a></li>
        <li class="active"><i class="fa fa-user-plus"></i>Advance Salary Report</li>
    </ol>
</section>
    ...
    <div class="row">
        ...
        <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
                <h3 class="box-title">Advance Salary Report download</h3>
            </div>
            <!-- /.box-header -->
