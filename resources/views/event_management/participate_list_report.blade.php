...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/event_management')}}"><i class="fa fa-money"></i> Event Management</a></li>
                ...
                <div class="col-md-12 col-md-offset-4" id="search_detail">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="event_name" style="width:100%;" class="form-control select2" id="event_name"
                                onchange="for_list();">
