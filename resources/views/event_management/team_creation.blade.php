...
function for_search11() {
    ...
    if (event_name != '' || gender != '' || category != '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "event_management/ajax_team_creation.php?event_name=" + event_name + "&gender=" +
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="event_name11" class="form-control" id="event_name"
                                                    ...
                                                    <option value="earth day celebration ">earth day celebration
                                                    </option>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="category11" class="form-control" id="category"
                                                    onchange="for_search11();" required>
                                                    <option value="All">All</option>
                                                    <option value=""></option>
