...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/event_management')}}"><i class="fa fa-calendar"></i>Event Management</a></li>
                ...
                <div class="box-body">
                    <div class="col-md-9">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="event_name" class="form-control" id="event_name"
                                    onchange="event_select(this.value);" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="activity_type" placeholder="Type Of The Activity" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="topic_theme" placeholder="Topic/Theme" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="date_day" placeholder="Date And Day" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="committee" placeholder="Name Of Committee" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="incharge" placeholder="Name Of Incharge" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_participants" placeholder="No Of Participants"
                                    id="total_participats" value="" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="invitation_card" placeholder="Circular/invitation" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="distribution_card"
                                    placeholder="Distribution Of Invitation Card" id="" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><small>Arrangement Of Sound System</small></label>
                                <input type="text" name="sound_system" placeholder="Arrangement Of Sound System" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="seating_guest" placeholder="Guest & Participants" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="green_room" placeholder="Arrangement Of Green Room" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="out_source" placeholder="Sound System/In Or Out Source" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="stage_arrangement" placeholder="Stage Arrangement" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="light_arrangement" placeholder="Arrangement Of Light" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_judges" placeholder="Name Of Judges" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="time_duration" placeholder="Time Duration" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="preparation" placeholder="Preparation" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="preparation_script" placeholder="Preparation Of Script" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="photography" placeholder="Photography" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="publicity_banner" placeholder="Publicity/Banner/Pressnote"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="refreshment" placeholder="Refreshment Arrangement" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="writting_report" placeholder="Writting Of Report" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="feedback_students" placeholder="Writting Of Report" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="feedback_parents" placeholder="Writting Of Report" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="amt_spent" placeholder="Writting Of Report" id=""
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="review_event" placeholder="Writting Of Report" id=""
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <center><input type="submit" name="submit" value="Submit" class="btn btn-primary"
                                onclick="return validation();" /></center>
                    </div>
                </div>
            </form>
