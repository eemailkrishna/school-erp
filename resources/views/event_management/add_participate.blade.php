                ...
                <form role="form" method="post" enctype="multipart/form-data" id="my_form">
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="participate_type" class="form-control" onchange="our_other(this.value);"
                                    required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="event_name" class="form-control" id="event_name"
                                    onchange="for_activity(this.value);" required>
                                    <option value="">Select</option>
                                    <option value=""></option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="school_name" id="school_name_1" placeholder="School Institute"
                    ...
                    <div class="col-md-3" id="birth_other">
                        <div class="form-group">
                            ...
                            <input type="date" name="dateofbirth" id="dateofbirth" placeholder="Date Of Birth" value=""
                                class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="category" required
                                placeholder="Eg:Dancing,Solo Dancing,Singing,etc" id="" class="form-control">
                        </div>
                    </div>
